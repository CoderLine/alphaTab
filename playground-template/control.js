...
function setupControl(selector) {
    ...
    at.soundFontLoaded.on(_ => {
        playerLoadingIndicator.classList.add('d-none');
    });
    at.renderFinished.on(_ => {
    ...
    control.querySelector('.at-speed').oninput = e => {
        e.stopPropagation();
    ...
    control.querySelector('.at-print').onclick = e => {
        at.print();
    };

    control.querySelectorAll('.at-zoom-options a').forEach(a => {
        a.onclick = e => {
            e.preventDefault();
    ...
    control.querySelectorAll('.at-layout-options a').forEach(a => {
        a.onclick = e => {
            e.preventDefault();
