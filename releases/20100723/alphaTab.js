...
net.alphatab.midi.MidiMessageUtils.NoteOn = function(channel,note,velocity) {
	return (((("NoteOn," + Std.string(net.alphatab.midi.MidiMessageUtils.fixChannel(channel))) + ",") + Std.string(net.alphatab.midi.MidiMessageUtils.fixValue(note))) + ",") + Std.string(net.alphatab.midi.MidiMessageUtils.fixValue(velocity));
}
net.alphatab.midi.MidiMessageUtils.NoteOff = function(channel,note,velocity) {
	return (((("NoteOff," + Std.string(net.alphatab.midi.MidiMessageUtils.fixChannel(channel))) + ",") + Std.string(net.alphatab.midi.MidiMessageUtils.fixValue(note))) + ",") + Std.string(net.alphatab.midi.MidiMessageUtils.fixValue(velocity));
}
net.alphatab.midi.MidiMessageUtils.ControlChange = function(channel,controller,value) {
	return (((("ControlChange," + Std.string(net.alphatab.midi.MidiMessageUtils.fixChannel(channel))) + ",") + Std.string(net.alphatab.midi.MidiMessageUtils.fixValue(controller))) + ",") + Std.string(net.alphatab.midi.MidiMessageUtils.fixValue(value));
}
net.alphatab.midi.MidiMessageUtils.ProgramChange = function(channel,instrument) {
	return (("ProgramChange," + Std.string(net.alphatab.midi.MidiMessageUtils.fixChannel(channel))) + ",") + Std.string(net.alphatab.midi.MidiMessageUtils.fixValue(instrument));
}
net.alphatab.midi.MidiMessageUtils.PitchBend = function(channel,value) {
	return (("PitchBend," + Std.string(net.alphatab.midi.MidiMessageUtils.fixChannel(channel))) + ",") + Std.string(net.alphatab.midi.MidiMessageUtils.fixValue(value));
}
...
net.alphatab.tablature.model.GsBeatImpl.prototype.PaintStroke = function(layout,context,x,y) {
	if(this.Stroke.Direction == net.alphatab.model.GsBeatStrokeDirection.None) return;
	var scale = layout.Scale;
	var realX = x;
...
net.alphatab.tablature.Tablature.prototype.DoLayout = function() {
	...
	haxe.Log.trace("Starting layouting",{ fileName : "Tablature.hx", lineNumber : 93, className : "net.alphatab.tablature.Tablature", methodName : "DoLayout"});
...
net.alphatab.tablature.Tablature.prototype.PaintBackground = function() {
	...
	this.Canvas.setTextBaseline("middle");
	var x = (this.Width - this.Canvas.measureText(msg).width) / 2;
	this.Canvas.fillText(msg,x,this.Height - 6);
}
net.alphatab.tablature.Tablature.prototype.SetTrack = function(track) {
	haxe.Log.trace("Updating Track",{ fileName : "Tablature.hx", lineNumber : 72, className : "net.alphatab.tablature.Tablature", methodName : "SetTrack"});
	this.Track = track;
