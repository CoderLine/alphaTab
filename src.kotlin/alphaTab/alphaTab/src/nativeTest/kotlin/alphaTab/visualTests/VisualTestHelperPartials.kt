...
//                Environment.renderEngines.set("skia", RenderEngineFactory(true) { SkiaCanvas() })
        ...
        public fun runVisualTestScoreWithResize(
            ...
            return // TODO: Find Skia Lib to use in native tests
...
//            val totalWidths = DoubleList()
//            val totalHeights = DoubleList()
//
...
//            try {
//                runBlocking {
//                    withTimeout(2000 * referenceImages.length.toLong()) {
//                        try {
...
//                fail("Rendering did not complete within timeout")
//            }
//
//            if (error != null) {
//                fail("Rendering failed with error $error ${error?.stackTraceToString()}")
//            } else {
