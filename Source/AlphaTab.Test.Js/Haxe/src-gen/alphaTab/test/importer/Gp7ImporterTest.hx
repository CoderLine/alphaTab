...
class Gp7ImporterTest extends alphaTab.test.importer.GpImporterTestBase
{
    ...
    public function TestBendAdvanced() : Void 
    {
        ...
        alphaTab.test.Assert.AreEqual_T1_T22(3, note.BendPoints.Count);
        alphaTab.test.Assert.AreEqual_T1_T22(0, note.BendPoints.get_Item(0).Offset);
        alphaTab.test.Assert.AreEqual_T1_T22(4, note.BendPoints.get_Item(0).Value);
        alphaTab.test.Assert.AreEqual_T1_T22(7, note.BendPoints.get_Item(1).Offset);
        alphaTab.test.Assert.AreEqual_T1_T22(5, note.BendPoints.get_Item(1).Value);
        alphaTab.test.Assert.AreEqual_T1_T22(15, note.BendPoints.get_Item(2).Offset);
        alphaTab.test.Assert.AreEqual_T1_T22(5, note.BendPoints.get_Item(2).Value);
        ...
        alphaTab.test.Assert.AreEqual_T1_T22(8, note.BendPoints.get_Item(0).Value);
        alphaTab.test.Assert.AreEqual_T1_T22(7, note.BendPoints.get_Item(1).Offset);
        alphaTab.test.Assert.AreEqual_T1_T22(10, note.BendPoints.get_Item(1).Value);
        alphaTab.test.Assert.AreEqual_T1_T22(16, note.BendPoints.get_Item(2).Offset);
        alphaTab.test.Assert.AreEqual_T1_T22(10, note.BendPoints.get_Item(2).Value);
