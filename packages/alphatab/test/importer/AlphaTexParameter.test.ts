...
describe('AlphaTexParameterTests', () => {
    describe('parser', () => {
        ...
        describe('metadata', () => {
            ...
            describe('type overloads', () => {
                it('overload1', () => parserTest('\\articulation defaults'));
        ...
        describe('props', () => {
            ...
            describe('type overloads', () => {
                it('overload1-number', () => parserTest('\\track { instrument 20 }'));
                it('overload2-string', () => parserTest('\\track { instrument "Acoustic Grand Piano"}'));
                it('overload2-identifier', () => parserTest('\\track { instrument AcousticGrandPiano }'));
                it('overload3-percussion', () => parserTest('\\track { instrument percussion }'));
            });
    ...
    describe('handler-validation', () => {
        function importTest(tex: string) {
            ...
            importer.parser!.mode = AlphaTexParseMode.Full;
        ...
        describe('metadata', () => {
            ...
            describe('single overload', () => {
                ...
                it('wrong type', () => importTest('\\jump (3)'));
            });
        ...
        describe('props', () => {
            ...
            describe('ambiguous', () => {
                it('incomplete', () => importTest('C4 { tu (3) }'));
            });
        });
    });
});
