...
export const articulation: MetadataDoc = {
    tag: '\\articulation',
    syntax: ['\\articulation defaults', '\\articulation name value'],
    ...
    values: [
        {
            name: 'defaults',
            shortDescription: 'Registers all standard articulation names',
            type: '`identifier`',
            required: true
        },
        {
            name: 'name',
            shortDescription: 'The string (or identifier) used in the note values',
            type: '`string` or `ìdentifier`',
            required: true
        },
        {
            name: 'value',
