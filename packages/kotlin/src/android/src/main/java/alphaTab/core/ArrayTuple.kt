...
data class ArrayTuple<T0, T1>(override var v0: T0, override var v1: T1) : IArrayTuple<T0, T1>
...
data class ObjectBooleanArrayTuple<T>(override var v0: T, override var v1: Boolean) :
    IObjectBooleanArrayTuple<T>

interface IObjectDoubleArrayTuple<T> : IArrayTuple<T, Double>
data class ObjectDoubleArrayTuple<T>(override var v0: T, override var v1: Double) :
    IObjectDoubleArrayTuple<T>

interface IDoubleObjectArrayTuple<T> : IArrayTuple<Double, T>
data class DoubleObjectArrayTuple<T>(override var v0: Double, override var v1: T) :
    IDoubleObjectArrayTuple<T>

interface IDoubleDoubleArrayTuple : IArrayTuple<Double, Double>
data class DoubleDoubleArrayTuple(override var v0: Double = 0.0, override var v1: Double = 0.0) :
    IDoubleDoubleArrayTuple

interface IDoubleBooleanArrayTuple : IArrayTuple<Double, Boolean>
data class DoubleBooleanArrayTuple(override var v0: Double = 0.0, override var v1: Boolean = false) :
