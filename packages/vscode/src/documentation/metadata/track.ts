...
export const track: MetadataDoc = {
    tag: '\\track',
    syntax: ['\\track', '\\track longName', '\\track (shortName longName)'],
    snippet: '\\track "$1"$0',
    ...
    values: [
        {
            name: 'longName',
            description: 'The long name of the track',
            type: 'string',
            required: false
        },
        {
            name: 'shortName',
            description: 'The short name of the track',
            type: 'string',
            required: false
        }
    ],
    ...
    properties: properties(
        ...
        },
        {
            ...
            values: [
                {
                    name: 'value',
                    description: 'The MIDI instrument to set',
        ...
        },
        {
            ...
            values: [
                {
                    name: 'value',
                    description: 'The midi bank to set	',
                    type: '`number`',
                    required: true,
                    values: new Map<AlphaTexNodeType, ValueItemDoc[]>([
                        [
