    ...
    values: [
       {
        ...
        values: new Map<AlphaTexNodeType, ValueItemDoc[]>([
          [AlphaTexNodeType.Ident, [
            ...
            {name: 'firstSystem', shortDescription: 'Track names are displayed on the first system.', snippet: 'firstSystem'},
            {name: 'allSystems', shortDescription: 'Track names are displayed on all systems.', snippet: 'allSystems'}
          ]]
        ])
      }
    ],
