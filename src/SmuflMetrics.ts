...
export class SmuflMetrics {
    ...
    public slightBeatVibratoStepSize: number = 12;
    public wideBeatVibratoStepSize: number = 23;
    ...
    public static readonly bravuraMetadata: SmuflMetadata = {
        ...
        glyphsWithAnchors: {
            accidentalDoubleFlat: {
                cutOutNE: [0.988, 1.344],
                cutOutSE: [1.336, 0.304]
            },
            accidentalFlat: {
                cutOutNE: [0.252, 1.356],
                cutOutSE: [0.504, 0.224]
            },
            accidentalNatural: {
                cutOutNE: [0.192, 2.116],
                cutOutSW: [0.476, 0.512]
            },
            accidentalQuarterToneFlatArrowUp: {
                cutOutNE: [0.772, 1.372],
                cutOutSE: [0.788, 0.256]
            },
            accidentalSharp: {
                cutOutNE: [0.84, 2.288],
                cutOutNW: [0.144, 1.96],
                cutOutSE: [0.84, 0.796],
                cutOutSW: [0.144, 0.496]
            },
            dynamicFF: {
            ...
            noteheadCircledBlack: {
                stemDownNW: [0.084, -0.164],
                stemUpSE: [1.264, 0.168]
            },
            noteheadCircledDoubleWhole: {
                noteheadOrigin: [0.356, 0]
            },
            noteheadCircledHalf: {
                stemDownNW: [0.072, -0.144],
                stemUpSE: [1.244, 0.156]
            },
            noteheadClusterDoubleWhole3rd: {
            ...
            noteheadWhole: {
                cutOutNW: [0.172, 0.832],
                cutOutSE: [1.532, 0.136]
            },
            noteheadXBlack: {
                stemDownNW: [0, -0.44],
                stemUpSE: [1.16, 0.444]
