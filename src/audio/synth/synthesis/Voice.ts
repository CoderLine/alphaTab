...
import { VoiceEnvelope, VoiceEnvelopeSegment } from '@src/audio/synth/synthesis/VoiceEnvelope';
import { VoiceLfo } from '@src/audio/synth/synthesis/VoiceLfo';
import { VoiceLowPass } from '@src/audio/synth/synthesis/VoiceLowPass';
...
export class Voice {
    ...
    public render(
        ...
        let input: Float32Array = f.fontSamples;
        let outL: number = 0;
        ...
        while (numSamples > 0) {
            ...
            let blockSamples: number = numSamples > 64 ? 64 : numSamples;
