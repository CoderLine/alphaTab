...
import net.alphatab.tablature.drawing.ClefPainter;
...
import net.alphatab.tablature.drawing.TempoPainter;
import net.alphatab.tablature.drawing.TripletFeelPainter;
import net.alphatab.tablature.TrackSpacing;
