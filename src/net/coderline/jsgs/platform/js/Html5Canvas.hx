...
class Html5Canvas implements Canvas 
{
	...
	public var lineCap(getLineCap, setLineCap):String; 
	private function getLineCap() : String
	{
		return this.context.lineCap;
	}
	private function setLineCap(value:String) : String
	{
		this.context.lineCap = value;
		return this.context.lineCap;
	}
	
	public var lineJoin(getLineJoin, setLineJoin):String; 
	private function getLineJoin() : String
	{
		return this.context.lineJoin;
	}
	private function setLineJoin(value:String) : String
	{
