...
export { Direction } from '@src/model/Direction';
...
export { Note, NoteSubElement, NoteStyle } from '@src/model/Note';
...
export { Track, TrackSubElement, TrackStyle } from '@src/model/Track';
