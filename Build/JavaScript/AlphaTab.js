...
$StaticConstructor(function (){
    ...
    // default staves 
    AlphaTab.Environment.StaveFactories["marker"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.MarkerEffectInfo());
    AlphaTab.Environment.StaveFactories["triplet-feel"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.TripletFeelEffectInfo());
    AlphaTab.Environment.StaveFactories["tempo"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.TempoEffectInfo());
    AlphaTab.Environment.StaveFactories["text"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.TextEffectInfo());
    AlphaTab.Environment.StaveFactories["chords"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.ChordsEffectInfo());
    AlphaTab.Environment.StaveFactories["trill"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.TrillEffectInfo());
    AlphaTab.Environment.StaveFactories["beat-vibrato"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.BeatVibratoEffectInfo());
    AlphaTab.Environment.StaveFactories["note-vibrato"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.NoteVibratoEffectInfo());
    AlphaTab.Environment.StaveFactories["alternate-endings"] = new AlphaTab.Rendering.AlternateEndingsBarRendererFactory();
    AlphaTab.Environment.StaveFactories["score"] = new AlphaTab.Rendering.ScoreBarRendererFactory();
    AlphaTab.Environment.StaveFactories["crescendo"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.CrescendoEffectInfo());
    AlphaTab.Environment.StaveFactories["dynamics"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.DynamicsEffectInfo());
    AlphaTab.Environment.StaveFactories["capo"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.CapoEffectInfo());
    AlphaTab.Environment.StaveFactories["tap"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.TapEffectInfo());
    AlphaTab.Environment.StaveFactories["fade-in"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.FadeInEffectInfo());
    AlphaTab.Environment.StaveFactories["harmonics"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.HarmonicsEffectInfo());
    AlphaTab.Environment.StaveFactories["let-ring"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.LetRingEffectInfo());
    AlphaTab.Environment.StaveFactories["palm-mute"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.PalmMuteEffectInfo());
    AlphaTab.Environment.StaveFactories["tab"] = new AlphaTab.Rendering.TabBarRendererFactory();
    AlphaTab.Environment.StaveFactories["pick-stroke"] = new AlphaTab.Rendering.EffectBarRendererFactory(new AlphaTab.Rendering.Effects.PickStrokeEffectInfo());
    AlphaTab.Environment.StaveFactories["rhythm-up"] = new AlphaTab.Rendering.RhythmBarRendererFactory(AlphaTab.Rendering.Utils.BeamDirection.Down);
    AlphaTab.Environment.StaveFactories["rhythm-down"] = new AlphaTab.Rendering.RhythmBarRendererFactory(AlphaTab.Rendering.Utils.BeamDirection.Up);
    // default combinations of stave textprofiles
    AlphaTab.Environment.StaveProfiles["default"] = AlphaTab.Environment.StaveProfiles["score-tab"] = ["tempo", "triplet-feel", "marker", "text", "chords", "trill", "beat-vibrato", "note-vibrato", "alternate-endings", "score", "crescendo", "dynamics", "trill", "beat-vibrato", "note-vibrato", "tap", "fade-in", "harmonics", "let-ring", "capo", "palm-mute", "pick-stroke", "tab"];
    AlphaTab.Environment.StaveProfiles["score"] = ["tempo", "triplet-feel", "marker", "text", "chords", "trill", "beat-vibrato", "note-vibrato", "fade-in", "alternate-endings", "let-ring", "palm-mute", "pick-stroke", "score", "crescendo", "dynamics"];
    AlphaTab.Environment.StaveProfiles["tab"] = ["tempo", "triplet-feel", "marker", "text", "chords", "trill", "beat-vibrato", "note-vibrato", "alternate-endings", "trill", "beat-vibrato", "note-vibrato", "tap", "fade-in", "harmonics", "let-ring", "capo", "palm-mute", "pick-stroke", "tab", "rhythm-down"];
});
...
AlphaTab.Platform.Std.GetNodeValue = function (n){
    ...
    if (n.nodeType == AlphaTab.Xml.XmlNodeType.Element || n.nodeType == AlphaTab.Xml.XmlNodeType.Document){
        ...
        AlphaTab.Platform.Std.IterateChildren(n, function (c){
            txt+=AlphaTab.Platform.Std.GetNodeValue(c);
        });
        return txt.trim();
    }
    return n.nodeValue;
...
AlphaTab.Settings.FillFromJson = function (settings, json){
    ...
    if ("atRoot"in json){
        ...
        if (!settings.ScriptFile.indexOf("http")==0 && !settings.ScriptFile.indexOf("https")==0){
            ...
            root+=settings.ScriptFile;
            settings.ScriptFile = root;
        }
    }
    else {
        settings.ScriptFile = AlphaTab.Environment.ScriptFile;
...
AlphaTab.Importer.GpxParser.prototype = {
    ...
    BuildModel: function (){
        ...
        // add tracks to score
        for (var $i16 = 0,$t16 = this._tracksMapping,$l16 = $t16.length,trackId = $t16[$i16]; $i16 < $l16; $i16++, trackId = $t16[$i16]){
        ...
        // build bars
        for (var $i17 = 0,$t17 = Object.keys(this._barsById),$l17 = $t17.length,barId = $t17[$i17]; $i17 < $l17; $i17++, barId = $t17[$i17]){
            var bar = this._barsById[barId];
            if (this._voicesOfBar.hasOwnProperty(barId)){
                // add voices to bars
                for (var $i18 = 0,$t18 = this._voicesOfBar[barId],$l18 = $t18.length,voiceId = $t18[$i18]; $i18 < $l18; $i18++, voiceId = $t18[$i18]){
                    if (voiceId != "-1"){
        ...
        // build beats
        for (var $i19 = 0,$t19 = Object.keys(this._beatById),$l19 = $t19.length,beatId = $t19[$i19]; $i19 < $l19; $i19++, beatId = $t19[$i19]){
            ...
            if (this._notesOfBeat.hasOwnProperty(beatId)){
                for (var $i20 = 0,$t20 = this._notesOfBeat[beatId],$l20 = $t20.length,noteId = $t20[$i20]; $i20 < $l20; $i20++, noteId = $t20[$i20]){
                    if (noteId != "-1"){
        ...
        // build voices
        for (var $i21 = 0,$t21 = Object.keys(this._voiceById),$l21 = $t21.length,voiceId = $t21[$i21]; $i21 < $l21; $i21++, voiceId = $t21[$i21]){
            var voice = this._voiceById[voiceId];
            if (this._beatsOfVoice.hasOwnProperty(voiceId)){
                // add beats to voices
                for (var $i22 = 0,$t22 = this._beatsOfVoice[voiceId],$l22 = $t22.length,beatId = $t22[$i22]; $i22 < $l22; $i22++, beatId = $t22[$i22]){
                    if (beatId != "-1"){
        ...
        // build automations
        for (var $i23 = 0,$t23 = Object.keys(this._automations),$l23 = $t23.length,barId = $t23[$i23]; $i23 < $l23; $i23++, barId = $t23[$i23]){
            var bar = this._barsById[barId];
            for (var i = 0,j = bar.Voices.length; i < j; i++){
                var v = bar.Voices[i];
                if (v.Beats.length > 0){
        ...
        // build automations
        for (var $i24 = 0,$t24 = Object.keys(this._automations),$l24 = $t24.length,barId = $t24[$i24]; $i24 < $l24; $i24++, barId = $t24[$i24]){
...
AlphaTab.Importer.MusicXmlImporter.prototype = {
        ...
        if (isFirstMeasure){
            ...
            if (attributes.length > 0){
                ...
                if (stavesElements.length > 0){
                    var staves = AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(stavesElements[0]));
    ...
    GetOrCreateBeat: function (element, bars, chord){
        ...
        if (chord || (voice.Beats.length == 1 && voice.get_IsEmpty())){
    ...
    ParseForward: function (element, bars){
        ...
        var durationInDivisions = AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(element.getElementsByTagName("duration")[0]));
        var duration = (durationInDivisions * 4) / this._divisionsPerQuarterNote;
        var durations = new Int32Array([64, 32, 16, 8, 4, 2, 1]);
        for (var $i25 = 0,$l25 = durations.length,d = durations[$i25]; $i25 < $l25; $i25++, d = durations[$i25]){
            if (duration >= d){
                beat.Duration = d;
                duration -= d;
                break;
    ...
    ParseStaffDetails: function (element, track){
        AlphaTab.Platform.Std.IterateChildren(element, $CreateAnonymousDelegate(this, function (c){
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    case "staff-lines":
                        track.Tuning = new Int32Array(AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(c)));
                        break;
                    case "staff-tuning":
    ...
    ParseStaffTuning: function (element, track){
        ...
        AlphaTab.Platform.Std.IterateChildren(element, $CreateAnonymousDelegate(this, function (c){
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    case "tuning-step":
                        tuningStep = AlphaTab.Platform.Std.GetNodeValue(c);
                        break;
                    case "tuning-alter":
                        tuningAlter = AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(c));
                        break;
                    case "tuning-octave":
                        tuningOctave = AlphaTab.Platform.Std.GetNodeValue(c);
                        break;
                }
            }
        }));
    ...
    ParseHarmony: function (element, track){
        ...
        var rootStep = AlphaTab.Platform.Std.GetNodeValue(root.getElementsByTagName("root-step")[0]);
        var kind = AlphaTab.Platform.Std.GetNodeValue(element.getElementsByTagName("kind")[0]);
        var chord = new AlphaTab.Model.Chord();
        chord.Name = rootStep;
            ...
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    ...
                    case "duration":
                        ...
                        var duration = AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(c));
                        switch (duration){
                            case 1:
                    ...
                    case "notehead":
                        ...
                        break;
                    case "beam":
                        var beamMode = AlphaTab.Platform.Std.GetNodeValue(c);
            ...
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    case "text":
                        ...
                        beat.Text += " " + AlphaTab.Platform.Std.GetNodeValue(c);
                    }
                        else {
                        beat.Text = AlphaTab.Platform.Std.GetNodeValue(c);
                    }
    ...
    ParseOrnaments: function (element, note){
        AlphaTab.Platform.Std.IterateChildren(element, $CreateAnonymousDelegate(this, function (c){
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    case "tremolo":
                        var tremoloSpeed = AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(c));
                        switch (tremoloSpeed){
                            case 1:
    ...
    ParseTechnical: function (element, note){
        AlphaTab.Platform.Std.IterateChildren(element, $CreateAnonymousDelegate(this, function (c){
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    case "string":
                        note.String = AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(c));
                        if (note.String != -2147483648){
                        note.String = note.Beat.Voice.Bar.Staff.Track.Tuning.length - note.String + 1;
                    }
                        break;
                    case "fret":
                        note.Fret = AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(c));
                        break;
                }
            }
        }));
            ...
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    case "step":
                        ...
                        break;
                    case "alter":
                        semitones = AlphaTab.Platform.Std.ParseFloat(AlphaTab.Platform.Std.GetNodeValue(c));
                        if (System.Single.IsNaN(semitones)){
                        semitones = 0;
                    }
                        break;
                    case "octave":
                ...
                switch (c.localName){
                    ...
                    case "direction-type":
                        ...
                        switch (directionType.localName){
                            case "words":
                            masterBar.Section = new AlphaTab.Model.Section();
                            masterBar.Section.Text = AlphaTab.Platform.Std.GetNodeValue(directionType);
                            break;
                        }
                        break;
                }
    ...
    ParseAttributes: function (element, bars, masterBar){
        ...
        AlphaTab.Platform.Std.IterateChildren(element, $CreateAnonymousDelegate(this, function (c){
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    case "divisions":
                        this._divisionsPerQuarterNote = AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(c));
                        break;
                    case "key":
            ...
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    case "sign":
                        ...
                        break;
                    case "line":
                        line = AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(c));
                        break;
                    case "clef-octave-change":
                        switch (AlphaTab.Platform.Std.ParseInt(AlphaTab.Platform.Std.GetNodeValue(c))){
                            case -2:
                            bar.ClefOttavia = AlphaTab.Model.ClefOttavia._15mb;
                            break;
                            case -1:
    ...
    ParseTime: function (element, masterBar){
        ...
        AlphaTab.Platform.Std.IterateChildren(element, $CreateAnonymousDelegate(this, function (c){
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                var v = AlphaTab.Platform.Std.GetNodeValue(c);
                switch (c.localName){
                    case "beats":
                        if (!beatsParsed){
                        if (!v.indexOf("+")!=-1){
            ...
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    ...
                    case "key-alter":
                        ...
                        break;
                    case "mode":
                        mode = AlphaTab.Platform.Std.GetNodeValue(c);
                        break;
                }
            }
        }));
            ...
            if (c.nodeType == AlphaTab.Xml.XmlNodeType.Element){
                switch (c.localName){
                    case "creator":
                        ...
                        this._score.Words = AlphaTab.Platform.Std.GetNodeValue(c.firstChild);
                    }
                        break;
                    case "rights":
                        ...
                        this._score.Copyright += AlphaTab.Platform.Std.GetNodeValue(c.firstChild);
                        break;
                }
            }
        }));
...
AlphaTab.Importer.ScoreLoader.LoadScoreFromBytes = function (data){
    ...
    for (var $i26 = 0,$l26 = importers.length,importer = importers[$i26]; $i26 < $l26; $i26++, importer = importers[$i26]){
        bb.Reset();
        try{
            importer.Init(bb);
...
AlphaTab.Model.Beat.prototype = {
    ...
    RemoveWhammyBarPoint: function (index){
        ...
        if (point != this.MaxWhammyPoint)
            return;
        this.MaxWhammyPoint = null;
        for (var $i27 = 0,$t27 = this.WhammyBarPoints,$l27 = $t27.length,currentPoint = $t27[$i27]; $i27 < $l27; $i27++, currentPoint = $t27[$i27]){
...
AlphaTab.Model.TuningParser.Parse = function (name){
    ...
    var result = new AlphaTab.Model.TuningParser.TuningParseResult();
    result.Octave = AlphaTab.Platform.Std.ParseInt(octave);
...
AlphaTab.Model.TuningParser.GetTuningForText = function (str){
    ...
    b = AlphaTab.Model.TuningParser.GetToneForText(result.Note);
    // add octaves
...
AlphaTab.Platform.Svg.SvgCanvas.prototype = {
    ...
    FillRect: function (x, y, w, h){
        ...
        this.Buffer+="\" height=\"";
        this.Buffer+=h;
        this.Buffer+="\" style=\"fill:";
        this.Buffer+=this.get_Color().RGBA;
        this.Buffer+="; shape-rendering: crispEdges;\" />\n";
    },
    StrokeRect: function (x, y, w, h){
        this.Buffer+="<rect x=\"";
        this.Buffer+=x - 0.5;
        ...
        this.Buffer+="\" height=\"";
        this.Buffer+=h;
        this.Buffer+="\" style=\"stroke:";
        this.Buffer+=this.get_Color().RGBA;
        if (this.get_LineWidth() != 1){
            this.Buffer+="; stroke-width:";
            this.Buffer+=this.get_LineWidth();
        }
    ...
    FillText: function (text, x, y){
        ...
        this.Buffer+=x;
        this.Buffer+="\" y=\"";
        this.Buffer+=y + this.GetSvgBaseLineOffset();
        this.Buffer+="\" style=\"font:";
        this.Buffer+=this.get_Font().ToCssString(1);
        this.Buffer+="; fill:";
        this.Buffer+=this.get_Color().RGBA;
        this.Buffer+=";\" ";
        this.Buffer+=" dominant-baseline=\"";
        this.Buffer+=this.GetSvgBaseLine();
        this.Buffer+="\" text-anchor=\"";
        this.Buffer+=this.GetSvgTextAlignment();
        this.Buffer+="\">\n";
        this.Buffer+=text;
        this.Buffer+="</text>\n";
    },
...
AlphaTab.Platform.Svg.FontSvgCanvas.prototype = {
    FillMusicFontSymbol: function (x, y, scale, symbol){
        this.Buffer+="<svg x=\"" + (x - 0.5) + "\" y=\"" + (y - 0.5) + "\" class=\"at\" ><text style=\"fill:" + this.get_Color().RGBA + "; ";
        if (scale != 1){
            this.Buffer+="font-size: " + (scale * 100) + "%";
        }
        this.Buffer+="\" text-anchor=\"start\">&#" + symbol + ";</text></svg>";
    }
};
...
AlphaTab.Rendering.BarRendererBase.prototype = {
    ...
    DoLayout: function (){
        ...
        this.Helpers = this.Staff.StaveGroup.Helpers.Helpers[this.Bar.Staff.Track.Index][this.Bar.Staff.Index][this.Bar.Index];
...
AlphaTab.Rendering.AlternateEndingsBarRenderer = function (renderer, bar){
    this._endings = null;
...
AlphaTab.Rendering.AlternateEndingsBarRenderer.prototype = {
    ...
    CreateVoiceGlyphs: function (voice){
        for (var i = 0,j = voice.Beats.length; i < j; i++){
            ...
            // effect bar sized
            var container = new AlphaTab.Rendering.Glyphs.BeatContainerGlyph(b, this.GetOrCreateVoiceContainer(voice));
...
AlphaTab.Rendering.AlternateEndingsBarRendererFactory.prototype = {
    Create: function (renderer, bar){
        return new AlphaTab.Rendering.AlternateEndingsBarRenderer(renderer, bar);
    }
};
...
AlphaTab.Rendering.EffectBarRenderer = function (renderer, bar, info){
    this._info = null;
...
AlphaTab.Rendering.EffectBarRenderer.prototype = {
    ...
    FinalizeRenderer: function (layout){
        ...
        this.IsEmpty = true;
        for (var $i28 = 0,$t28 = this.Bar.Voices,$l28 = $t28.length,voice = $t28[$i28]; $i28 < $l28; $i28++, voice = $t28[$i28]){
            for (var $i29 = 0,$t29 = Object.keys(this._effectGlyphs[voice.Index]),$l29 = $t29.length,key = $t29[$i29]; $i29 < $l29; $i29++, key = $t29[$i29]){
    ...
    CreateBeatGlyphs: function (){
        for (var $i30 = 0,$t30 = this.Bar.Voices,$l30 = $t30.length,voice = $t30[$i30]; $i30 < $l30; $i30++, voice = $t30[$i30]){
    ...
    CreateVoiceGlyphs: function (v){
        for (var $i31 = 0,$t31 = v.Beats,$l31 = $t31.length,b = $t31[$i31]; $i31 < $l31; $i31++, b = $t31[$i31]){
            // we create empty glyphs as alignment references and to get the 
            // effect bar sized
...
AlphaTab.Rendering.EffectBarRendererFactory.prototype = {
    Create: function (renderer, bar){
        return new AlphaTab.Rendering.EffectBarRenderer(renderer, bar, this._info);
    }
};
...
AlphaTab.Rendering.Glyphs.TieGlyph.prototype = {
    ...
    Paint: function (cx, cy, canvas){
        ...
        var endNoteRenderer = this.Renderer.ScoreRenderer.Layout.GetRendererForBar(this.Renderer.Staff.StaveId, this.EndBeat.Voice.Bar);
        var startX = 0;
        var endX = 0;
        var startY = 0;
        var endY = 0;
    ...
    DoLayout: function (){
        ...
        if (!this.Container.Beat.IsEmpty){
            if (!this.Container.Beat.get_IsRest()){
                ...
                for (var $i32 = 0,$t32 = this.Container.Beat.Notes,$l32 = $t32.length,note = $t32[$i32]; $i32 < $l32; $i32++, note = $t32[$i32]){
...
AlphaTab.Rendering.Glyphs.ScoreNoteChordGlyph.prototype = {
    ...
    Paint: function (cx, cy, canvas){
        ...
        canvas.set_Color(this.Beat.Voice.Index == 0 ? this.Renderer.ScoreRenderer.RenderingResources.MainGlyphColor : this.Renderer.ScoreRenderer.RenderingResources.SecondaryGlyphColor);
        ...
        for (var trackIndex = 0; trackIndex < this.Renderer.Tracks.length; trackIndex++){
            ...
            for (var staveIndex = 0; staveIndex < track.Staves.length; staveIndex++){
                for (var renderStaveIndex = 0; renderStaveIndex < profile.length; renderStaveIndex++){
                    ...
                    if (AlphaTab.Environment.StaveFactories.hasOwnProperty(s)){
                        var factory = AlphaTab.Environment.StaveFactories[s];
                        if (factory.CanCreate(track) && (isFirstTrack || !factory.HideOnMultiTrack) && (staveIndex == 0 || !factory.HideOnMultiTrack)){
                            group.AddStave(track, new AlphaTab.Rendering.Staves.Staff(track.Staves[staveIndex], s, factory, this.Renderer.Settings.Staves.AdditionalSettings));
                        }
                    }
                }
            }
    ...
    CreateStaveGroup: function (currentBarIndex, endIndex){
        ...
        for (var i = currentBarIndex; i < end; i++){
            ...
            if (this._barsFromPreviousGroup != null && this._barsFromPreviousGroup.MasterBar.Index == i){
                addResult = group.AddBarsFromResult(this.Renderer.Tracks, this._barsFromPreviousGroup);
            }
            else {
                addResult = group.AddBars(this.Renderer.Tracks, i);
            }
            this._barsFromPreviousGroup = null;
            ...
            if (groupIsFull){
                ...
                group.IsFull = true;
                group.IsLast = false;
                this._barsFromPreviousGroup = addResult;
                return group;
            }
            group.X = 0;
        }
...
AlphaTab.Rendering.RhythmBarRenderer = function (renderer, bar, direction){
...
AlphaTab.Rendering.RhythmBarRendererFactory.prototype = {
    Create: function (renderer, bar){
        return new AlphaTab.Rendering.RhythmBarRenderer(renderer, bar, this._direction);
    }
};
...
AlphaTab.Rendering.ScoreBarRenderer.prototype = {
    ...
    PaintBar: function (cx, cy, canvas, h){
        for (var i = 0,j = h.Beats.length; i < j; i++){
            ...
            var barSpacing = 6 * this.get_Scale() * scaleMod;
    ...
    CreatePostBeatGlyphs: function (){
        ...
        if (this.Bar.NextBar == null || !this.Bar.NextBar.get_MasterBar().IsRepeatStart){
    ...
    CreateKeySignatureGlyphs: function (){
        ...
        for (var $i36 = 0,$l36 = newGlyphs.length,newGlyph = newGlyphs[$i36]; $i36 < $l36; $i36++, newGlyph = newGlyphs[$i36]){
...
AlphaTab.Rendering.Staves.StaveGroup.prototype = {
    ...
    AddBarsFromResult: function (tracks, result){
        if (tracks.length == 0)
            return null;
        this.Helpers.ImportHelpers(tracks, result.Helpers);
        this.MasterBars.push(result.MasterBar);
    ...
    AddBars: function (tracks, barIndex){
        ...
        result.Helpers = this.Helpers.BuildHelpers(tracks, barIndex);
        result.MasterBar = tracks[0].Score.MasterBars[barIndex];
        this.MasterBars.push(result.MasterBar);
        this.CalculateAccoladeSpacing(tracks);
        // add renderers
        result.BarLayoutingInfo = new AlphaTab.Rendering.Staves.BarLayoutingInfo();
        for (var i = 0,j = this.Staves.length; i < j; i++){
            var g = this.Staves[i];
            for (var k = 0,l = g.Staves.length; k < l; k++){
                var s = g.Staves[k];
...
AlphaTab.Rendering.TabBarRenderer.prototype = {
    ...
    PaintBackground: function (cx, cy, canvas){
        ...
        for (var $i37 = 0,$t37 = this.Bar.Voices,$l37 = $t37.length,voice = $t37[$i37]; $i37 < $l37; $i37++, voice = $t37[$i37]){
            var vc = this.GetOrCreateVoiceContainer(voice);
            for (var $i38 = 0,$t38 = vc.BeatGlyphs,$l38 = $t38.length,bg = $t38[$i38]; $i38 < $l38; $i38++, bg = $t38[$i38]){
        ...
        for (var $i39 = 0,$l39 = tabNotes.length,line = tabNotes[$i39]; $i39 < $l39; $i39++, line = tabNotes[$i39]){
    ...
    return a[0] > b[0] ? 1 : a[0] < b[0] ? -1 : 0;
        ...
        for (var i = 0,j = this.Bar.Staff.Track.Tuning.length; i < j; i++){
            if (i > 0)
                lineY += lineOffset;
            var lineX = 0;
            for (var $i40 = 0,$t40 = tabNotes[i],$l40 = $t40.length,line = $t40[$i40]; $i40 < $l40; $i40++, line = $t40[$i40]){
...
AlphaTab.Rendering.TabBarRendererFactory.prototype = {
    ...
    Create: function (renderer, bar){
        return new AlphaTab.Rendering.TabBarRenderer(renderer, bar);
    }
};
...
AlphaTab.Rendering.Utils.BarHelpersGroup.prototype = {
    ImportHelpers: function (tracks, helpers){
        for (var $i41 = 0,$l41 = tracks.length,track = tracks[$i41]; $i41 < $l41; $i41++, track = tracks[$i41]){
            var h = this.GetOrCreateForTrack(track);
            for (var s = 0; s < track.Staves.length; s++){
                for (var barIndex in helpers.Helpers[track.Index][s]){
    ...
    BuildHelpers: function (tracks, barIndex){
        var result = new AlphaTab.Rendering.Utils.BarHelpersGroup();
        for (var $i42 = 0,$l42 = tracks.length,track = tracks[$i42]; $i42 < $l42; $i42++, track = tracks[$i42]){
            var resultH = result.GetOrCreateForTrack(track);
            var h = this.GetOrCreateForTrack(track);
            for (var s = 0; s < track.Staves.length; s++){
                if (!h[s].hasOwnProperty(barIndex)){
                    h[s][barIndex] = new AlphaTab.Rendering.Utils.BarHelpers(track.Staves[s].Bars[barIndex]);
                }
    ...
    GetOrCreateForTrack: function (track){
        var h;
        if (!this.Helpers.hasOwnProperty(track.Index)){
            h = [];
            for (var s = 0; s < track.Staves.length; s++){
                h.push({});
            }
            this.Helpers[track.Index] = h;
        }
        else {
            h = this.Helpers[track.Index];
        }
        return h;
    }
};
        ...
        if (!this.get_Eof() || !skipChar){
            ...
            if (AlphaTab.Platform.Std.IsCharNumber(c, true)){
                ...
                while (!this.get_Eof() && (AlphaTab.Platform.Std.IsCharNumber(c, false) || c == 46)){
                    token+=String.fromCharCode(this.NextChar());
...
AlphaTab.Model.TuningParser = AlphaTab.Model.TuningParser || {};
AlphaTab.Model.TuningParser.TuningParseResult = function (){
    this.Note = null;
    this.Octave = 0;
};
