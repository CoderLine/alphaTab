...
AlphaTab.Model.Note.prototype = {
    ...
    get_StringTuning: function (){
        return AlphaTab.Model.Note.GetStringTuning(this.Beat.Voice.Bar.Staff.Track, this.String);
    },
...
AlphaTab.Rendering.GroupedBarRenderer.prototype = {
    ...
    ApplySizes: function (sizes){
        ...
        // add a new spacer
        this._preBeatGlyphs.Width = sizes.GetSize("Pre");
        ...
        this._postBeatGlyphs.Width = sizes.GetSize("Post");
        this.Width = sizes.FullWidth;
    },
...
AlphaTab.Rendering.Glyphs.ScoreBeatPreNotesGlyph.prototype = {
    DoLayout: function (){
        ...
        if (!this.Container.Beat.get_IsRest() && !this.Container.Beat.Voice.Bar.Staff.Track.IsPercussion){
...
AlphaTab.Rendering.Glyphs.VoiceContainerGlyph.prototype = {
    ...
    ApplySizes: function (sizes){
        ...
        if (sizes.MinStretchForce > this.CurrentForce){
            this.ScaleToForce(sizes.MinStretchForce);
        }
        if (this.BeatGlyphs.length > 0){
...
AlphaTab.Rendering.Staves.BarSizeInfo.prototype = {
    ...
    AddSpring: function (beat){
        ...
        if (!this.Springs.hasOwnProperty(start)){
            ...
            this.Springs[start].Beats.push(beat);
        }
        var duration = beat.CalculateDuration();
...
AlphaTab.Rendering.Utils.AccidentalHelper.prototype = {
    ...
    GetNoteLineWithAccidental: function (n, accidentalToSet){
        var value = n.Beat.Voice.Bar.Staff.Track.IsPercussion ? AlphaTab.Rendering.Utils.PercussionMapper.MapValue(n) : n.get_RealValue();
