...
alphatab.importer.GpImporterTestBase.prototype = $extend(haxe.unit.TestCase.prototype,{
	...
	,checkOtherEffects: function(score) {
		...
		this.assertTrue(score.tracks[0].bars[0].voices[0].beats[2].notes[0].tapping,{ fileName : "GpImporterTestBase.hx", lineNumber : 305, className : "alphatab.importer.GpImporterTestBase", methodName : "checkOtherEffects"});
	...
	,checkTrills: function(score) {
		...
		this.assertTrue(score.tracks[0].bars[0].voices[0].beats[1].tremoloSpeed >= 0,{ fileName : "GpImporterTestBase.hx", lineNumber : 291, className : "alphatab.importer.GpImporterTestBase", methodName : "checkTrills"});
		this.assertEquals(3,score.tracks[0].bars[0].voices[0].beats[1].tremoloSpeed,{ fileName : "GpImporterTestBase.hx", lineNumber : 292, className : "alphatab.importer.GpImporterTestBase", methodName : "checkTrills"});
		this.assertTrue(score.tracks[0].bars[0].voices[0].beats[2].tremoloSpeed >= 0,{ fileName : "GpImporterTestBase.hx", lineNumber : 294, className : "alphatab.importer.GpImporterTestBase", methodName : "checkTrills"});
		this.assertEquals(2,score.tracks[0].bars[0].voices[0].beats[2].tremoloSpeed,{ fileName : "GpImporterTestBase.hx", lineNumber : 295, className : "alphatab.importer.GpImporterTestBase", methodName : "checkTrills"});
		this.assertTrue(score.tracks[0].bars[0].voices[0].beats[3].tremoloSpeed >= 0,{ fileName : "GpImporterTestBase.hx", lineNumber : 297, className : "alphatab.importer.GpImporterTestBase", methodName : "checkTrills"});
		this.assertEquals(1,score.tracks[0].bars[0].voices[0].beats[3].tremoloSpeed,{ fileName : "GpImporterTestBase.hx", lineNumber : 298, className : "alphatab.importer.GpImporterTestBase", methodName : "checkTrills"});
	}
...
alphatab.importer.Gp3ImporterTest.prototype = $extend(alphatab.importer.GpImporterTestBase.prototype,{
	...
	,testOtherEffects: function() {
		...
		var score = reader.readScore();
		this.assertTrue(score.tracks[0].bars[0].voices[0].beats[2].notes[0].tapping,{ fileName : "Gp3ImporterTest.hx", lineNumber : 131, className : "alphatab.importer.Gp3ImporterTest", methodName : "testOtherEffects"});
...
alphatab.rendering.glyphs.ScoreBeatGlyph.prototype = $extend(alphatab.rendering.glyphs.BeatGlyphBase.prototype,{
	...
	,canScale: function() {
		return alphatab.rendering.glyphs.BeatGlyphBase.prototype.canScale.call(this);
	}
	,beamingHelper: null
	,restGlyph: null
	,noteHeads: null
...
alphatab.rendering.glyphs.ScoreBeatPreNotesGlyph.prototype = $extend(alphatab.rendering.glyphs.BeatGlyphBase.prototype,{
	createAccidentalGlyph: function(n,accidentals) {
		...
		switch( (accidental)[1] ) {
		case 2:
			accidentals.addGlyph(new alphatab.rendering.glyphs.SharpGlyph(0,sr.getScoreY(noteLine)));
			break;
		case 3:
			accidentals.addGlyph(new alphatab.rendering.glyphs.FlatGlyph(0,sr.getScoreY(noteLine)));
			break;
		case 1:
			accidentals.addGlyph(new alphatab.rendering.glyphs.NaturalizeGlyph(0,sr.getScoreY(noteLine + 1)));
			break;
		default:
		}
	}
