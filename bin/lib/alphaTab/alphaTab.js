...
net.alphatab.file.alphatex.AlphaTexParser.isLetter = function(ch) {
	...
	return !net.alphatab.file.alphatex.AlphaTexParser.isTerminal(ch) && ((code >= 33 && code <= 47) || (code >= 58 && code <= 126) || (code > 128));
}
net.alphatab.file.alphatex.AlphaTexParser.isTerminal = function(ch) {
...
net.alphatab.file.alphatex.AlphaTexParser.prototype._currentDuration = null;
...
net.alphatab.file.alphatex.AlphaTexParser.prototype.applyBeatEffect = function(beat) {
	if(this._syData == "f") {
		...
		this.newSy();
		if(this._sy != net.alphatab.file.alphatex.AlphaTexSymbols.Number) {
			this.error("tuplet",net.alphatab.file.alphatex.AlphaTexSymbols.Number);
			return false;
		}
...
net.alphatab.file.alphatex.AlphaTexParser.prototype.beat = function(measure) {
	if(this._sy == net.alphatab.file.alphatex.AlphaTexSymbols.DoubleDot) {
		this.newSy();
		if(this._sy != net.alphatab.file.alphatex.AlphaTexSymbols.Number) {
...
net.alphatab.file.alphatex.AlphaTexParser.prototype.beatEffects = function(beat) {
	...
	this.newSy();
	while(this._sy == net.alphatab.file.alphatex.AlphaTexSymbols.String) {
...
net.alphatab.file.alphatex.AlphaTexParser.prototype.isDigit = function(ch) {
	var code = ch.charCodeAt(0);
...
net.alphatab.file.alphatex.AlphaTexParser.prototype.newSy = function() {
	...
	do {
		if(this._ch == String.fromCharCode(0)) {
			...
			this._sy = net.alphatab.file.alphatex.AlphaTexSymbols.DoubleDot;
			this.nextChar();
		}
		else if(this._ch == "(") {
...
net.alphatab.file.alphatex.AlphaTexParser.prototype.note = function(beat) {
...
net.alphatab.file.alphatex.AlphaTexParser.prototype.noteEffects = function(beat,effect) {
	if(this._sy != net.alphatab.file.alphatex.AlphaTexSymbols.LBrace) {
		return;
	}
	this.newSy();
	while(this._sy == net.alphatab.file.alphatex.AlphaTexSymbols.String) {
		...
		if(this._syData == "b") {
			...
			this.newSy();
			if(this._sy != net.alphatab.file.alphatex.AlphaTexSymbols.Number && !(this._sy == net.alphatab.file.alphatex.AlphaTexSymbols.String && Std.string(this._syData).toLowerCase() == "x")) {
				this.error("grace-effect-fret",net.alphatab.file.alphatex.AlphaTexSymbols.Number);
			}
			var isDead = Std.string(this._syData).toLowerCase() == "x";
			...
			var transition = net.alphatab.model.effects.GraceEffectTransition.None;
			if(this._sy == net.alphatab.file.alphatex.AlphaTexSymbols.String) {
				if(this._syData == "s") {
					transition = net.alphatab.model.effects.GraceEffectTransition.Slide;
					this.newSy();
				}
				else if(this._syData == "b") {
					transition = net.alphatab.model.effects.GraceEffectTransition.Bend;
					this.newSy();
				}
				else if(this._syData == "h") {
					transition = net.alphatab.model.effects.GraceEffectTransition.Hammer;
					this.newSy();
				}
			}
			...
			this.error(this._syData,net.alphatab.file.alphatex.AlphaTexSymbols.String,false);
		}
	}
	if(this._sy != net.alphatab.file.alphatex.AlphaTexSymbols.RBrace) {
...
net.alphatab.file.alphatex.AlphaTexParser.prototype.readName = function() {
	...
	do {
		str += this._ch;
		this.nextChar();
	} while(net.alphatab.file.alphatex.AlphaTexParser.isLetter(this._ch) || this.isDigit(this._ch));
	return str;
}
...
net.alphatab.platform.Canvas.prototype.circle = null;
net.alphatab.platform.Canvas.prototype.clear = null;
...
net.alphatab.model.Beat.prototype.ensureVoices = function(count,factory) {
...
net.alphatab.tablature.model.NoteImpl.prototype.getNoteWidth = function() {
...
net.alphatab.tablature.model.NoteImpl.prototype.getPosX = function() {
...
net.alphatab.platform.js.Html5Canvas.prototype.circle = function(x,y,radius) {
	this._context.arc(x,y,radius,0,Math.PI * 2,true);
}
net.alphatab.platform.js.Html5Canvas.prototype.clear = function() {
