...
alphatab.model.VoiceDirection = { __ename__ : ["alphatab","model","VoiceDirection"], __constructs__ : ["None","Up","Down"] }
alphatab.model.VoiceDirection.Down = ["Down",2];
alphatab.model.VoiceDirection.Down.toString = $estr;
alphatab.model.VoiceDirection.Down.__enum__ = alphatab.model.VoiceDirection;
alphatab.model.VoiceDirection.None = ["None",0];
alphatab.model.VoiceDirection.None.toString = $estr;
alphatab.model.VoiceDirection.None.__enum__ = alphatab.model.VoiceDirection;
alphatab.model.VoiceDirection.Up = ["Up",1];
alphatab.model.VoiceDirection.Up.toString = $estr;
alphatab.model.VoiceDirection.Up.__enum__ = alphatab.model.VoiceDirection;
...
alphatab.file.gpx.score.Track = function(p) { if( p === $_ ) return; {
	null;
}}
alphatab.file.gpx.score.Track.__name__ = ["alphatab","file","gpx","score","Track"];
alphatab.file.gpx.score.Track.prototype.color = null;
alphatab.file.gpx.score.Track.prototype.gmChannel1 = null;
alphatab.file.gpx.score.Track.prototype.gmChannel2 = null;
alphatab.file.gpx.score.Track.prototype.gmProgram = null;
alphatab.file.gpx.score.Track.prototype.id = null;
alphatab.file.gpx.score.Track.prototype.name = null;
alphatab.file.gpx.score.Track.prototype.tunningPitches = null;
alphatab.file.gpx.score.Track.prototype.__class__ = alphatab.file.gpx.score.Track;
...
alphatab.file.gpx.score.Rhythm = function(p) { if( p === $_ ) return; {
	null;
}}
alphatab.file.gpx.score.Rhythm.__name__ = ["alphatab","file","gpx","score","Rhythm"];
alphatab.file.gpx.score.Rhythm.prototype.augmentationDotCount = null;
alphatab.file.gpx.score.Rhythm.prototype.id = null;
alphatab.file.gpx.score.Rhythm.prototype.noteValue = null;
alphatab.file.gpx.score.Rhythm.prototype.primaryTupletDen = null;
alphatab.file.gpx.score.Rhythm.prototype.primaryTupletNum = null;
alphatab.file.gpx.score.Rhythm.prototype.__class__ = alphatab.file.gpx.score.Rhythm;
...
alphatab.file.guitarpro.Gp3Reader.prototype.readBeatEffects = function(beat,effect) {
	...
	if((flags1 & 64) != 0) {
		...
		if(strokeUp > 0) {
			beat.effect.stroke.direction = alphatab.model.BeatStrokeDirection.Up;
			beat.effect.stroke.value = (alphatab.file.guitarpro.Gp3Reader.toStrokeValue(strokeUp));
		}
		else if(strokeDown > 0) {
			beat.effect.stroke.direction = alphatab.model.BeatStrokeDirection.Down;
...
alphatab.file.guitarpro.Gp3Reader.prototype.readBend = function(noteEffect) {
	...
	bendEffect.type = alphatab.model.effects.BendTypesConverter.fromInt(this.readByte());
...
alphatab.file.guitarpro.Gp3Reader.prototype.readGrace = function(noteEffect) {
	...
	switch(transition) {
	case 0:{
		grace.transition = alphatab.model.effects.GraceEffectTransition.None;
	}break;
	case 1:{
		grace.transition = alphatab.model.effects.GraceEffectTransition.Slide;
	}break;
	case 2:{
		grace.transition = alphatab.model.effects.GraceEffectTransition.Bend;
	}break;
	case 3:{
		grace.transition = alphatab.model.effects.GraceEffectTransition.Hammer;
	}break;
	}
...
alphatab.file.guitarpro.Gp3Reader.prototype.readSong = function() {
	...
	this.readInfo(song);
	this._tripletFeel = (this.readBool()?alphatab.model.TripletFeel.Eighth:alphatab.model.TripletFeel.None);
...
alphatab.file.guitarpro.Gp3Reader.prototype.readTremoloBar = function(effect) {
	...
	barEffect.type = alphatab.model.effects.BendTypesConverter.fromInt(this.readByte());
...
alphatab.MyTrace = function() { }
alphatab.MyTrace.__name__ = ["alphatab","MyTrace"];
alphatab.MyTrace.init = function() {
	haxe.Log.trace = $closure(alphatab.MyTrace,"trace");
}
alphatab.MyTrace.trace = function(v,i) {
	null;
}
alphatab.MyTrace.prototype.__class__ = alphatab.MyTrace;
...
alphatab.file.gpx.score.MasterBar = function(p) { if( p === $_ ) return; {
	null;
}}
alphatab.file.gpx.score.MasterBar.__name__ = ["alphatab","file","gpx","score","MasterBar"];
alphatab.file.gpx.score.MasterBar.prototype.barIds = null;
alphatab.file.gpx.score.MasterBar.prototype.repeatCount = null;
alphatab.file.gpx.score.MasterBar.prototype.repeatStart = null;
alphatab.file.gpx.score.MasterBar.prototype.time = null;
alphatab.file.gpx.score.MasterBar.prototype.__class__ = alphatab.file.gpx.score.MasterBar;
if(!alphatab.tablature) alphatab.tablature = {}
alphatab.tablature.TrackSpacingPositions = { __ename__ : ["alphatab","tablature","TrackSpacingPositions"], __constructs__ : ["Top","Marker","Text","BufferSeparator","RepeatEnding","Chord","ScoreUpLines","ScoreMiddleLines","ScoreDownLines","Tupleto","AccentuatedEffect","HarmonicEffect","TapingEffect","LetRingEffect","PalmMuteEffect","BeatVibratoEffect","VibratoEffect","FadeIn","Bend","TablatureTopSeparator","Tablature","TremoloBarDown","Lyric","Bottom"] }
alphatab.tablature.TrackSpacingPositions.AccentuatedEffect = ["AccentuatedEffect",10];
alphatab.tablature.TrackSpacingPositions.AccentuatedEffect.toString = $estr;
alphatab.tablature.TrackSpacingPositions.AccentuatedEffect.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.BeatVibratoEffect = ["BeatVibratoEffect",15];
alphatab.tablature.TrackSpacingPositions.BeatVibratoEffect.toString = $estr;
alphatab.tablature.TrackSpacingPositions.BeatVibratoEffect.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.Bend = ["Bend",18];
alphatab.tablature.TrackSpacingPositions.Bend.toString = $estr;
alphatab.tablature.TrackSpacingPositions.Bend.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.Bottom = ["Bottom",23];
alphatab.tablature.TrackSpacingPositions.Bottom.toString = $estr;
alphatab.tablature.TrackSpacingPositions.Bottom.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.BufferSeparator = ["BufferSeparator",3];
alphatab.tablature.TrackSpacingPositions.BufferSeparator.toString = $estr;
alphatab.tablature.TrackSpacingPositions.BufferSeparator.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.Chord = ["Chord",5];
alphatab.tablature.TrackSpacingPositions.Chord.toString = $estr;
alphatab.tablature.TrackSpacingPositions.Chord.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.FadeIn = ["FadeIn",17];
alphatab.tablature.TrackSpacingPositions.FadeIn.toString = $estr;
alphatab.tablature.TrackSpacingPositions.FadeIn.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.HarmonicEffect = ["HarmonicEffect",11];
alphatab.tablature.TrackSpacingPositions.HarmonicEffect.toString = $estr;
alphatab.tablature.TrackSpacingPositions.HarmonicEffect.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.LetRingEffect = ["LetRingEffect",13];
alphatab.tablature.TrackSpacingPositions.LetRingEffect.toString = $estr;
alphatab.tablature.TrackSpacingPositions.LetRingEffect.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.Lyric = ["Lyric",22];
alphatab.tablature.TrackSpacingPositions.Lyric.toString = $estr;
alphatab.tablature.TrackSpacingPositions.Lyric.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.Marker = ["Marker",1];
alphatab.tablature.TrackSpacingPositions.Marker.toString = $estr;
alphatab.tablature.TrackSpacingPositions.Marker.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.PalmMuteEffect = ["PalmMuteEffect",14];
alphatab.tablature.TrackSpacingPositions.PalmMuteEffect.toString = $estr;
alphatab.tablature.TrackSpacingPositions.PalmMuteEffect.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.RepeatEnding = ["RepeatEnding",4];
alphatab.tablature.TrackSpacingPositions.RepeatEnding.toString = $estr;
alphatab.tablature.TrackSpacingPositions.RepeatEnding.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.ScoreDownLines = ["ScoreDownLines",8];
alphatab.tablature.TrackSpacingPositions.ScoreDownLines.toString = $estr;
alphatab.tablature.TrackSpacingPositions.ScoreDownLines.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines = ["ScoreMiddleLines",7];
alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines.toString = $estr;
alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.ScoreUpLines = ["ScoreUpLines",6];
alphatab.tablature.TrackSpacingPositions.ScoreUpLines.toString = $estr;
alphatab.tablature.TrackSpacingPositions.ScoreUpLines.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.Tablature = ["Tablature",20];
alphatab.tablature.TrackSpacingPositions.Tablature.toString = $estr;
alphatab.tablature.TrackSpacingPositions.Tablature.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.TablatureTopSeparator = ["TablatureTopSeparator",19];
alphatab.tablature.TrackSpacingPositions.TablatureTopSeparator.toString = $estr;
alphatab.tablature.TrackSpacingPositions.TablatureTopSeparator.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.TapingEffect = ["TapingEffect",12];
alphatab.tablature.TrackSpacingPositions.TapingEffect.toString = $estr;
alphatab.tablature.TrackSpacingPositions.TapingEffect.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.Text = ["Text",2];
alphatab.tablature.TrackSpacingPositions.Text.toString = $estr;
alphatab.tablature.TrackSpacingPositions.Text.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.Top = ["Top",0];
alphatab.tablature.TrackSpacingPositions.Top.toString = $estr;
alphatab.tablature.TrackSpacingPositions.Top.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.TremoloBarDown = ["TremoloBarDown",21];
alphatab.tablature.TrackSpacingPositions.TremoloBarDown.toString = $estr;
alphatab.tablature.TrackSpacingPositions.TremoloBarDown.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.Tupleto = ["Tupleto",9];
alphatab.tablature.TrackSpacingPositions.Tupleto.toString = $estr;
alphatab.tablature.TrackSpacingPositions.Tupleto.__enum__ = alphatab.tablature.TrackSpacingPositions;
alphatab.tablature.TrackSpacingPositions.VibratoEffect = ["VibratoEffect",16];
alphatab.tablature.TrackSpacingPositions.VibratoEffect.toString = $estr;
alphatab.tablature.TrackSpacingPositions.VibratoEffect.__enum__ = alphatab.tablature.TrackSpacingPositions;
if(!alphatab.tablature.drawing) alphatab.tablature.drawing = {}
alphatab.tablature.drawing.DrawingLayersConverter = function() { }
alphatab.tablature.drawing.DrawingLayersConverter.__name__ = ["alphatab","tablature","drawing","DrawingLayersConverter"];
alphatab.tablature.drawing.DrawingLayersConverter.toInt = function(layer) {
	switch(layer) {
	case alphatab.tablature.drawing.DrawingLayers.Background:{
		return 0;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.LayoutBackground:{
		return 1;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.Lines:{
		return 2;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.MainComponents:{
		return 3;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.MainComponentsDraw:{
		return 4;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.Voice2:{
		return 5;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.VoiceEffects2:{
		return 6;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw2:{
		return 7;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.VoiceDraw2:{
		return 8;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.Voice1:{
		return 9;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.VoiceEffects1:{
		return 10;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw1:{
		return 11;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.VoiceDraw1:{
		return 12;
	}break;
	case alphatab.tablature.drawing.DrawingLayers.Red:{
		return 13;
	}break;
	default:{
		return 0;
...
alphatab.tablature.drawing.DrawingLayersConverter.prototype.__class__ = alphatab.tablature.drawing.DrawingLayersConverter;
...
alphatab.tablature.drawing.DrawingContext = function(scale) { if( scale === $_ ) return; {
	...
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.Background)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(205,205,205),true,0);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.LayoutBackground)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(34,34,17),true,0);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.Lines)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(165,165,165),false,1);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.MainComponents)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(34,34,17),true,0);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.MainComponentsDraw)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(34,34,17),false,scale);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.Voice2)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(206,206,206),true,1);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.VoiceEffects2)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(183,183,183),true,0);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw2)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(183,183,183),false,scale);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.VoiceDraw2)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(206,206,206),false,scale);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.Voice1)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(34,34,17),true,1);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.VoiceEffects1)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(34,34,17),true,0);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw1)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(34,34,17),false,scale);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.VoiceDraw1)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(34,34,17),false,scale);
	this.layers[alphatab.tablature.drawing.DrawingLayersConverter.toInt(alphatab.tablature.drawing.DrawingLayers.Red)] = new alphatab.tablature.drawing.DrawingLayer(new alphatab.model.Color(255,0,0),true,0);
}}
...
alphatab.tablature.drawing.DrawingContext.prototype.get = function(layer) {
	var index = alphatab.tablature.drawing.DrawingLayersConverter.toInt(layer);
...
alphatab.file.SongLoader.loadSong = function(url,factory,success) {
	...
	haxe.Log.trace("Load song " + url,{ fileName : "SongLoader.hx", lineNumber : 41, className : "alphatab.file.SongLoader", methodName : "loadSong"});
	loader.loadBinary("GET",url,function(data) {
		var readers = alphatab.file.SongReader.availableReaders();
		haxe.Log.trace("Song loaded, search for reader",{ fileName : "SongLoader.hx", lineNumber : 47, className : "alphatab.file.SongLoader", methodName : "loadSong"});
		{
			var _g = 0;
			while(_g < readers.length) {
				...
				++_g;
				try {
					haxe.Log.trace("Try Reader " + Type.getClassName(Type.getClass(reader)),{ fileName : "SongLoader.hx", lineNumber : 52, className : "alphatab.file.SongLoader", methodName : "loadSong"});
					data.seek(0);
					reader.init(data,factory);
					var song = reader.readSong();
					haxe.Log.trace("Reading succeeded",{ fileName : "SongLoader.hx", lineNumber : 56, className : "alphatab.file.SongLoader", methodName : "loadSong"});
					success(song);
					return;
				}
				catch( $e6 ) {
					if( js.Boot.__instanceof($e6,alphatab.file.FileFormatException) ) {
						var e = $e6;
						{
							haxe.Log.trace("Reading failed",{ fileName : "SongLoader.hx", lineNumber : 62, className : "alphatab.file.SongLoader", methodName : "loadSong"});
							continue;
						}
					} else throw($e6);
				}
		...
		haxe.Log.trace("Error loading file " + err,{ fileName : "SongLoader.hx", lineNumber : 71, className : "alphatab.file.SongLoader", methodName : "loadSong"});
		throw err;
	});
}
...
alphatab.midi.MidiSequenceHandler.prototype.addEvent = function(track,tick,evt) {
	var command = (((alphatab.midi.MidiMessageUtils.intToString(track) + "|") + alphatab.midi.MidiMessageUtils.intToString(tick)) + "|") + evt;
...
alphatab.midi.MidiSequenceHandler.prototype.notifyFinish = function() {
	this.commands = (alphatab.midi.MidiMessageUtils.intToString(this.metronomeTrack) + ";") + this._commands.join(";");
}
alphatab.midi.MidiSequenceHandler.prototype.__class__ = alphatab.midi.MidiSequenceHandler;
alphatab.model.MeasureClefConverter = function() { }
alphatab.model.MeasureClefConverter.__name__ = ["alphatab","model","MeasureClefConverter"];
alphatab.model.MeasureClefConverter.toInt = function(clef) {
	switch(clef) {
	case alphatab.model.MeasureClef.Treble:{
		return 1;
	}break;
	case alphatab.model.MeasureClef.Bass:{
		return 2;
	}break;
	case alphatab.model.MeasureClef.Tenor:{
		return 3;
	}break;
	case alphatab.model.MeasureClef.Alto:{
		return 4;
	}break;
	default:{
		return 1;
...
alphatab.model.MeasureClefConverter.toString = function(clef) {
	switch(clef) {
	case alphatab.model.MeasureClef.Treble:{
		return "treble";
	}break;
...
alphatab.model.MeasureClefConverter.prototype.__class__ = alphatab.model.MeasureClefConverter;
...
alphatab.tablature.ViewLayout.prototype.checkDefaultSpacing = function(ts) {
	var bufferSeparator = ts.get(alphatab.tablature.TrackSpacingPositions.ScoreUpLines) - ts.get(alphatab.tablature.TrackSpacingPositions.BufferSeparator);
	if(bufferSeparator < this.minBufferSeparator) {
		ts.set(alphatab.tablature.TrackSpacingPositions.BufferSeparator,Math.round(this.minBufferSeparator - bufferSeparator));
	}
	var checkPosition = ts.get(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines);
	if(checkPosition >= 0 && checkPosition < this.minTopSpacing) {
		ts.set(alphatab.tablature.TrackSpacingPositions.Top,Math.round(this.minTopSpacing - checkPosition));
	}
}
...
alphatab.tablature.ViewLayout.prototype.paintCache = function(graphics,area,fromX,fromY) {
	...
	haxe.Log.trace("Painting _cache",{ fileName : "ViewLayout.hx", lineNumber : 118, className : "alphatab.tablature.ViewLayout", methodName : "paintCache"});
	this._cache.draw();
}
alphatab.tablature.ViewLayout.prototype.paintLines = function(track,ts,context,x,y,width) {
	if(width > 0) {
		...
		var tempY = y;
		var posY = tempY + ts.get(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines);
		{
			var _g = 1;
			while(_g < 6) {
				var i = _g++;
				context.get(alphatab.tablature.drawing.DrawingLayers.Lines).startFigure();
				context.get(alphatab.tablature.drawing.DrawingLayers.Lines).addLine(Math.round(tempX),Math.round(posY),Math.round(tempX + width),Math.round(posY));
				posY += (this.scoreLineSpacing);
			}
		}
		tempY += ts.get(alphatab.tablature.TrackSpacingPositions.Tablature);
		{
			var _g1 = 0, _g = track.stringCount();
			while(_g1 < _g) {
				var i = _g1++;
				context.get(alphatab.tablature.drawing.DrawingLayers.Lines).startFigure();
				context.get(alphatab.tablature.drawing.DrawingLayers.Lines).addLine(Math.round(tempX),Math.round(tempY),Math.round(tempX + width),Math.round(tempY));
...
alphatab.tablature.ViewLayout.prototype.updateCache = function(graphics,area,fromX,fromY) {
	haxe.Log.trace("Updating _cache",{ fileName : "ViewLayout.hx", lineNumber : 124, className : "alphatab.tablature.ViewLayout", methodName : "updateCache"});
...
alphatab.tablature.ViewLayout.prototype.updateSong = function() {
	...
	haxe.Log.trace("Updating Song Data",{ fileName : "ViewLayout.hx", lineNumber : 145, className : "alphatab.tablature.ViewLayout", methodName : "updateSong"});
	this.updateTracks();
	haxe.Log.trace("Updating Song Data finished",{ fileName : "ViewLayout.hx", lineNumber : 147, className : "alphatab.tablature.ViewLayout", methodName : "updateSong"});
}
...
alphatab.file.gpx.score.Document = function(p) { if( p === $_ ) return; {
	this.score = new alphatab.file.gpx.score.Score();
...
alphatab.file.gpx.score.Document.__name__ = ["alphatab","file","gpx","score","Document"];
alphatab.file.gpx.score.Document.prototype.automations = null;
alphatab.file.gpx.score.Document.prototype.bars = null;
alphatab.file.gpx.score.Document.prototype.beats = null;
alphatab.file.gpx.score.Document.prototype.getAutomation = function(type,untilBarId) {
	var result = null;
	{
...
alphatab.file.gpx.score.Document.prototype.getBar = function(id) {
	{
...
alphatab.file.gpx.score.Document.prototype.getBeat = function(id) {
	{
...
alphatab.file.gpx.score.Document.prototype.getNote = function(id) {
	{
...
alphatab.file.gpx.score.Document.prototype.getRhythm = function(id) {
	{
...
alphatab.file.gpx.score.Document.prototype.getVoice = function(id) {
	{
		var _g = 0, _g1 = this.voices;
		while(_g < _g1.length) {
			var voice = _g1[_g];
...
alphatab.file.gpx.score.Document.prototype.masterBars = null;
alphatab.file.gpx.score.Document.prototype.notes = null;
alphatab.file.gpx.score.Document.prototype.rythms = null;
alphatab.file.gpx.score.Document.prototype.score = null;
alphatab.file.gpx.score.Document.prototype.tracks = null;
alphatab.file.gpx.score.Document.prototype.voices = null;
alphatab.file.gpx.score.Document.prototype.__class__ = alphatab.file.gpx.score.Document;
alphatab.model.MeasureClef = { __ename__ : ["alphatab","model","MeasureClef"], __constructs__ : ["Treble","Bass","Tenor","Alto"] }
alphatab.model.MeasureClef.Alto = ["Alto",3];
alphatab.model.MeasureClef.Alto.toString = $estr;
alphatab.model.MeasureClef.Alto.__enum__ = alphatab.model.MeasureClef;
alphatab.model.MeasureClef.Bass = ["Bass",1];
alphatab.model.MeasureClef.Bass.toString = $estr;
alphatab.model.MeasureClef.Bass.__enum__ = alphatab.model.MeasureClef;
alphatab.model.MeasureClef.Tenor = ["Tenor",2];
alphatab.model.MeasureClef.Tenor.toString = $estr;
alphatab.model.MeasureClef.Tenor.__enum__ = alphatab.model.MeasureClef;
alphatab.model.MeasureClef.Treble = ["Treble",0];
alphatab.model.MeasureClef.Treble.toString = $estr;
alphatab.model.MeasureClef.Treble.__enum__ = alphatab.model.MeasureClef;
alphatab.model.Measure = function(header) { if( header === $_ ) return; {
	this.header = header;
	this.clef = alphatab.model.MeasureClef.Treble;
	this.beats = new Array();
}}
...
alphatab.tablature.TrackSpacingPositionConverter = function() { }
alphatab.tablature.TrackSpacingPositionConverter.__name__ = ["alphatab","tablature","TrackSpacingPositionConverter"];
alphatab.tablature.TrackSpacingPositionConverter.toInt = function(pos) {
	switch(pos) {
	case alphatab.tablature.TrackSpacingPositions.Top:{
		return 0;
	}break;
	case alphatab.tablature.TrackSpacingPositions.Marker:{
		return 1;
	}break;
	case alphatab.tablature.TrackSpacingPositions.Text:{
		return 2;
	}break;
	case alphatab.tablature.TrackSpacingPositions.BufferSeparator:{
		return 3;
	}break;
	case alphatab.tablature.TrackSpacingPositions.RepeatEnding:{
		return 4;
	}break;
	case alphatab.tablature.TrackSpacingPositions.Chord:{
		return 5;
	}break;
	case alphatab.tablature.TrackSpacingPositions.ScoreUpLines:{
		return 6;
	}break;
	case alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines:{
		return 7;
	}break;
	case alphatab.tablature.TrackSpacingPositions.ScoreDownLines:{
		return 8;
	}break;
	case alphatab.tablature.TrackSpacingPositions.Tupleto:{
		return 9;
	}break;
	case alphatab.tablature.TrackSpacingPositions.AccentuatedEffect:{
		return 10;
	}break;
	case alphatab.tablature.TrackSpacingPositions.HarmonicEffect:{
		return 11;
	}break;
	case alphatab.tablature.TrackSpacingPositions.TapingEffect:{
		return 12;
	}break;
	case alphatab.tablature.TrackSpacingPositions.LetRingEffect:{
		return 13;
	}break;
	case alphatab.tablature.TrackSpacingPositions.PalmMuteEffect:{
		return 14;
	}break;
	case alphatab.tablature.TrackSpacingPositions.BeatVibratoEffect:{
		return 15;
	}break;
	case alphatab.tablature.TrackSpacingPositions.VibratoEffect:{
		return 16;
	}break;
	case alphatab.tablature.TrackSpacingPositions.FadeIn:{
		return 17;
	}break;
	case alphatab.tablature.TrackSpacingPositions.Bend:{
		return 18;
	}break;
	case alphatab.tablature.TrackSpacingPositions.TablatureTopSeparator:{
		return 19;
	}break;
	case alphatab.tablature.TrackSpacingPositions.Tablature:{
		return 20;
	}break;
	case alphatab.tablature.TrackSpacingPositions.TremoloBarDown:{
		return 21;
	}break;
	case alphatab.tablature.TrackSpacingPositions.Lyric:{
		return 22;
	}break;
	case alphatab.tablature.TrackSpacingPositions.Bottom:{
		return 23;
	}break;
	default:{
		return 0;
...
alphatab.tablature.TrackSpacingPositionConverter.prototype.__class__ = alphatab.tablature.TrackSpacingPositionConverter;
alphatab.file.gpx.score.Note = function(p) { if( p === $_ ) return; {
	this.id = -1;
	this.fret = -1;
	this.string = -1;
	this.tone = -1;
...
alphatab.file.gpx.score.Note.__name__ = ["alphatab","file","gpx","score","Note"];
alphatab.file.gpx.score.Note.prototype.element = null;
alphatab.file.gpx.score.Note.prototype.fret = null;
alphatab.file.gpx.score.Note.prototype.id = null;
alphatab.file.gpx.score.Note.prototype.midiNumber = null;
alphatab.file.gpx.score.Note.prototype.mutedEnabled = null;
alphatab.file.gpx.score.Note.prototype.octave = null;
alphatab.file.gpx.score.Note.prototype.palmMutedEnabled = null;
alphatab.file.gpx.score.Note.prototype.slide = null;
alphatab.file.gpx.score.Note.prototype.string = null;
alphatab.file.gpx.score.Note.prototype.tieDestination = null;
alphatab.file.gpx.score.Note.prototype.tone = null;
alphatab.file.gpx.score.Note.prototype.variation = null;
alphatab.file.gpx.score.Note.prototype.vibrato = null;
alphatab.file.gpx.score.Note.prototype.__class__ = alphatab.file.gpx.score.Note;
...
alphatab.file.guitarpro.Gp4Reader.prototype.readNoteEffects = function(noteEffect) {
	...
	if((flags2 & 8) != 0) {
		...
		switch(type) {
		case 1:{
			noteEffect.slideType = alphatab.model.SlideType.FastSlideTo;
		}break;
		case 2:{
			noteEffect.slideType = alphatab.model.SlideType.SlowSlideTo;
		}break;
		case 4:{
			noteEffect.slideType = alphatab.model.SlideType.OutDownWards;
		}break;
		case 8:{
			noteEffect.slideType = alphatab.model.SlideType.OutUpWards;
		}break;
		case 16:{
			noteEffect.slideType = alphatab.model.SlideType.IntoFromBelow;
		}break;
		case 32:{
			noteEffect.slideType = alphatab.model.SlideType.IntoFromAbove;
		}break;
		}
	}
	if((flags2 & 16) != 0) {
...
alphatab.tablature.model.BeatTextImpl.prototype.paint = function(layout,context,x,y) {
	...
	var realY = y + measure.ts.get(alphatab.tablature.TrackSpacingPositions.Text);
	context.get(alphatab.tablature.drawing.DrawingLayers.Voice1).addString(this.value,alphatab.tablature.drawing.DrawingResources.defaultFont,realX,realY);
}
...
alphatab.model.BeatStrokeDirection = { __ename__ : ["alphatab","model","BeatStrokeDirection"], __constructs__ : ["None","Up","Down"] }
alphatab.model.BeatStrokeDirection.Down = ["Down",2];
alphatab.model.BeatStrokeDirection.Down.toString = $estr;
alphatab.model.BeatStrokeDirection.Down.__enum__ = alphatab.model.BeatStrokeDirection;
alphatab.model.BeatStrokeDirection.None = ["None",0];
alphatab.model.BeatStrokeDirection.None.toString = $estr;
alphatab.model.BeatStrokeDirection.None.__enum__ = alphatab.model.BeatStrokeDirection;
alphatab.model.BeatStrokeDirection.Up = ["Up",1];
alphatab.model.BeatStrokeDirection.Up.toString = $estr;
alphatab.model.BeatStrokeDirection.Up.__enum__ = alphatab.model.BeatStrokeDirection;
alphatab.tablature.drawing.SvgPainter = function(layer,svg,x,y,xScale,yScale) { if( layer === $_ ) return; {
	...
	this._currentPosition = new alphatab.model.PointF(x,y);
...
alphatab.file.alphatex.AlphaTexParser.prototype.noteEffects = function(beat,effect) {
	...
	while(this._sy == alphatab.file.alphatex.AlphaTexSymbols.String) {
		...
		if(this._syData == "b") {
			...
			var transition = alphatab.model.effects.GraceEffectTransition.None;
			if(this._sy == alphatab.file.alphatex.AlphaTexSymbols.String) {
				if(this._syData == "s") {
					transition = alphatab.model.effects.GraceEffectTransition.Slide;
					this.newSy();
				}
				else if(this._syData == "b") {
					transition = alphatab.model.effects.GraceEffectTransition.Bend;
					this.newSy();
				}
				else if(this._syData == "h") {
					transition = alphatab.model.effects.GraceEffectTransition.Hammer;
					this.newSy();
				}
			}
			...
			this.newSy();
			effect.slide = true;
			effect.slideType = alphatab.model.SlideType.FastSlideTo;
		}
		else if(this._syData == "sf") {
			this.newSy();
			effect.slide = true;
			effect.slideType = alphatab.model.SlideType.SlowSlideTo;
		}
		else if(this._syData == "h") {
			this.newSy();
			effect.hammer = true;
...
alphatab.file.alphatex.AlphaTexParser.prototype.parseClef = function(str) {
	...
	case "treble":{
		return alphatab.model.MeasureClef.Treble;
	}break;
	case "bass":{
		return alphatab.model.MeasureClef.Bass;
	}break;
	case "tenor":{
		return alphatab.model.MeasureClef.Tenor;
	}break;
	case "alto":{
		return alphatab.model.MeasureClef.Alto;
	}break;
	default:{
		return alphatab.model.MeasureClef.Treble;
	}break;
...
alphatab.model.Voice = function(factory,index) { if( factory === $_ ) return; {
	...
	this.notes = new Array();
	this.index = index;
	this.direction = alphatab.model.VoiceDirection.None;
	this.isEmpty = true;
}}
...
alphatab.tablature.drawing.NotePainter.paintFooter = function(layer,x,y,dur,dir,layout) {
	...
	if(dir == -1) {
		x += alphatab.tablature.drawing.DrawingResources.getScoreNoteSize(layout,false).width;
	}
	var s = "";
	switch(dur) {
	case 64:{
...
alphatab.tablature.drawing.NotePainter.paintBar = function(layer,x1,y1,x2,y2,count,dir,scale) {
	var width = Math.max(1.0,Math.round(3.0 * scale));
	{
		...
		while(_g < count) {
			...
			layer.startFigure();
			layer.addPolygon([new alphatab.model.PointF(x1,realY1),new alphatab.model.PointF(x2,realY2),new alphatab.model.PointF(x2,realY2 + width),new alphatab.model.PointF(x1,realY1 + width),new alphatab.model.PointF(x1,realY1)]);
			layer.closeFigure();
		}
	}
}
...
alphatab.model.SlideType = { __ename__ : ["alphatab","model","SlideType"], __constructs__ : ["FastSlideTo","SlowSlideTo","OutDownWards","OutUpWards","IntoFromBelow","IntoFromAbove"] }
alphatab.model.SlideType.FastSlideTo = ["FastSlideTo",0];
alphatab.model.SlideType.FastSlideTo.toString = $estr;
alphatab.model.SlideType.FastSlideTo.__enum__ = alphatab.model.SlideType;
alphatab.model.SlideType.IntoFromAbove = ["IntoFromAbove",5];
...
alphatab.model.SlideType.IntoFromBelow = ["IntoFromBelow",4];
...
alphatab.model.SlideType.OutDownWards = ["OutDownWards",2];
alphatab.model.SlideType.OutDownWards.toString = $estr;
alphatab.model.SlideType.OutDownWards.__enum__ = alphatab.model.SlideType;
alphatab.model.SlideType.OutUpWards = ["OutUpWards",3];
alphatab.model.SlideType.OutUpWards.toString = $estr;
alphatab.model.SlideType.OutUpWards.__enum__ = alphatab.model.SlideType;
alphatab.model.SlideType.SlowSlideTo = ["SlowSlideTo",1];
alphatab.model.SlideType.SlowSlideTo.toString = $estr;
alphatab.model.SlideType.SlowSlideTo.__enum__ = alphatab.model.SlideType;
		...
		while((offset = (offset + sectorSize)) + 3 < bcfsBytes.length) {
			if(this.getInteger(bcfsBytes,offset) == 2) {
				...
				if(fileBytes.length >= fileSize) {
					this._fileSystem.push(new alphatab.file.gpx.File(this.getString(bcfsBytes,indexFileName,127),this.getBytes(fileBytes,0,fileSize)));
				}
			}
		}
	}
...
alphatab.file.guitarpro.Gp5Reader.prototype.readMeasureHeader = function(i,timeSignature,song) {
	...
	switch(tripletFeel) {
	case 1:{
		header.tripletFeel = alphatab.model.TripletFeel.Eighth;
	}break;
	case 2:{
		header.tripletFeel = alphatab.model.TripletFeel.Sixteenth;
	}break;
	default:{
		header.tripletFeel = alphatab.model.TripletFeel.None;
	}break;
	}
	return header;
}
...
alphatab.tablature.PageViewLayout.prototype.PaintLine = function(track,line,beatCount,context) {
	haxe.Log.trace((("Paint Measures " + Std.string(line.Measures[0])) + " to ") + Std.string(line.Measures[line.Measures.length - 1]),{ fileName : "PageViewLayout.hx", lineNumber : 292, className : "alphatab.tablature.PageViewLayout", methodName : "PaintLine"});
	{
...
alphatab.tablature.PageViewLayout.prototype.init = function(scale) {
	...
	this.layoutSize = new alphatab.model.Size(this.getSheetWidth() - alphatab.tablature.PageViewLayout.PAGE_PADDING.getHorizontal(),this.height);
}
...
alphatab.tablature.PageViewLayout.prototype.paintSongInfo = function(ctx,clientArea,x,y) {
	haxe.Log.trace("Paint Song info",{ fileName : "PageViewLayout.hx", lineNumber : 203, className : "alphatab.tablature.PageViewLayout", methodName : "paintSongInfo"});
	var song = this.tablature.track.song;
	...
	if(song.title != "" && ((song.pageSetup.headerAndFooter & 1) != 0)) {
		...
		ctx.get(alphatab.tablature.drawing.DrawingLayers.LayoutBackground).addString(str,alphatab.tablature.drawing.DrawingResources.titleFont,tX,y,"top");
		y += Math.floor(35 * this.scale);
	}
	if(song.subtitle != "" && ((song.pageSetup.headerAndFooter & 2) != 0)) {
		...
		size = ctx.graphics.measureText(str);
		tX = (clientArea.width - size) / 2;
		ctx.get(alphatab.tablature.drawing.DrawingLayers.LayoutBackground).addString(str,alphatab.tablature.drawing.DrawingResources.subtitleFont,tX,y,"top");
		y += Math.floor(20 * this.scale);
	}
	if(song.artist != "" && ((song.pageSetup.headerAndFooter & 4) != 0)) {
	...
	if(song.music != "" && song.music == song.words && ((song.pageSetup.headerAndFooter & 64) != 0)) {
		...
		ctx.get(alphatab.tablature.drawing.DrawingLayers.LayoutBackground).addString(str,alphatab.tablature.drawing.DrawingResources.wordsFont,x,y,"top");
		y += Math.floor(20 * this.scale);
	}
	else {
		if(song.music != "" && ((song.pageSetup.headerAndFooter & 32) != 0)) {
			...
			size = ctx.graphics.measureText(str);
			tX = ((clientArea.width - size) - this.contentPadding.right);
			ctx.get(alphatab.tablature.drawing.DrawingLayers.LayoutBackground).addString(str,alphatab.tablature.drawing.DrawingResources.wordsFont,tX,y,"top");
		}
		if(song.words != "" && ((song.pageSetup.headerAndFooter & 16) != 0)) {
...
alphatab.tablature.PageViewLayout.prototype.prepareLayout = function(clientArea,x,y) {
	...
	while(measureCount > nextMeasureIndex) {
		...
		spacing.set(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines,Math.round(this.scoreLineSpacing * 5));
		var line = this.GetTempLines(track,nextMeasureIndex,spacing);
		this._lines.push(line);
		spacing.set(alphatab.tablature.TrackSpacingPositions.ScoreUpLines,Math.round(Math.abs(line.MinY)));
		if(line.MaxY + this.minScoreTabSpacing > this.scoreSpacing) {
			spacing.set(alphatab.tablature.TrackSpacingPositions.ScoreDownLines,Math.round(line.MaxY - (this.scoreLineSpacing * 4)));
		}
		spacing.set(alphatab.tablature.TrackSpacingPositions.TablatureTopSeparator,Math.round(this.minScoreTabSpacing));
		spacing.set(alphatab.tablature.TrackSpacingPositions.Tablature,Math.round((track.tabHeight + this.stringSpacing) + 1));
		spacing.set(alphatab.tablature.TrackSpacingPositions.Lyric,10);
...
alphatab.model.effects.GraceEffectTransition = { __ename__ : ["alphatab","model","effects","GraceEffectTransition"], __constructs__ : ["None","Slide","Bend","Hammer"] }
alphatab.model.effects.GraceEffectTransition.Bend = ["Bend",2];
alphatab.model.effects.GraceEffectTransition.Bend.toString = $estr;
alphatab.model.effects.GraceEffectTransition.Bend.__enum__ = alphatab.model.effects.GraceEffectTransition;
alphatab.model.effects.GraceEffectTransition.Hammer = ["Hammer",3];
alphatab.model.effects.GraceEffectTransition.Hammer.toString = $estr;
alphatab.model.effects.GraceEffectTransition.Hammer.__enum__ = alphatab.model.effects.GraceEffectTransition;
alphatab.model.effects.GraceEffectTransition.None = ["None",0];
alphatab.model.effects.GraceEffectTransition.None.toString = $estr;
alphatab.model.effects.GraceEffectTransition.None.__enum__ = alphatab.model.effects.GraceEffectTransition;
alphatab.model.effects.GraceEffectTransition.Slide = ["Slide",1];
alphatab.model.effects.GraceEffectTransition.Slide.toString = $estr;
alphatab.model.effects.GraceEffectTransition.Slide.__enum__ = alphatab.model.effects.GraceEffectTransition;
alphatab.model.effects.BendEffect = function(p) { if( p === $_ ) return; {
	this.type = alphatab.model.effects.BendTypes.None;
	this.value = 0;
...
alphatab.tablature.model.BeatImpl.prototype.paintBeatEffects = function(context,layout,x,y) {
	...
	var fill = context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffects1);
	if(this.effect.stroke.direction != alphatab.model.BeatStrokeDirection.None) {
	...
	if(this.effect.fadeIn) {
		var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.FadeIn);
		this.paintFadeIn(layout,context,realX,realY);
	}
	if(this.effect.tapping) {
		var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.TapingEffect);
	...
	if(this.effect.vibrato) {
		var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.BeatVibratoEffect);
		this.paintVibrato(layout,context,realX,realY,1);
	}
	if(this.effect.isTremoloBar()) {
		var string = (this.minNote == null?6:this.minNote.string);
		var realY = (y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.Tablature)) + Math.round((string - 1) * layout.stringSpacing);
...
alphatab.tablature.model.BeatImpl.prototype.paintExtraLines = function(context,layout,x,y) {
	if(!this.isRestBeat()) {
		var scoreY = y + this.measureImpl().ts.get(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines);
...
alphatab.tablature.model.BeatImpl.prototype.paintExtraLines2 = function(context,layout,note,x,y) {
	...
	if(realY < y) {
		...
		while(i > realY) {
			context.get(alphatab.tablature.drawing.DrawingLayers.Lines).startFigure();
			context.get(alphatab.tablature.drawing.DrawingLayers.Lines).addLine(x1,i,x2,i);
...
alphatab.tablature.model.BeatImpl.prototype.paintFadeIn = function(layout,context,x,y) {
	...
	var layer = context.get(alphatab.tablature.drawing.DrawingLayers.VoiceDraw1);
	layer.startFigure();
...
alphatab.tablature.model.BeatImpl.prototype.paintStroke = function(layout,context,x,y) {
	if(this.effect.stroke.direction == alphatab.model.BeatStrokeDirection.None) return;
	var scale = layout.scale;
	var realX = x;
	var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.Tablature);
	var y1 = realY;
	var y2 = realY + this.measureImpl().trackImpl().tabHeight;
	var layer = context.get(alphatab.tablature.drawing.DrawingLayers.MainComponentsDraw);
	layer.startFigure();
	if(this.effect.stroke.direction == alphatab.model.BeatStrokeDirection.Up) {
...
alphatab.tablature.model.BeatImpl.prototype.paintTremoloBar = function(layout,context,nextBeat,x,y) {
	...
	var fill = context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffects1);
	var draw = context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw1);
...
alphatab.tablature.drawing.DrawingLayers = { __ename__ : ["alphatab","tablature","drawing","DrawingLayers"], __constructs__ : ["Background","LayoutBackground","Lines","MainComponents","MainComponentsDraw","Voice2","VoiceEffects2","VoiceEffectsDraw2","VoiceDraw2","Voice1","VoiceEffects1","VoiceEffectsDraw1","VoiceDraw1","Red"] }
alphatab.tablature.drawing.DrawingLayers.Background = ["Background",0];
alphatab.tablature.drawing.DrawingLayers.Background.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.Background.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.LayoutBackground = ["LayoutBackground",1];
alphatab.tablature.drawing.DrawingLayers.LayoutBackground.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.LayoutBackground.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.Lines = ["Lines",2];
alphatab.tablature.drawing.DrawingLayers.Lines.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.Lines.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.MainComponents = ["MainComponents",3];
alphatab.tablature.drawing.DrawingLayers.MainComponents.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.MainComponents.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.MainComponentsDraw = ["MainComponentsDraw",4];
alphatab.tablature.drawing.DrawingLayers.MainComponentsDraw.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.MainComponentsDraw.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.Red = ["Red",13];
alphatab.tablature.drawing.DrawingLayers.Red.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.Red.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.Voice1 = ["Voice1",9];
alphatab.tablature.drawing.DrawingLayers.Voice1.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.Voice1.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.Voice2 = ["Voice2",5];
alphatab.tablature.drawing.DrawingLayers.Voice2.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.Voice2.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.VoiceDraw1 = ["VoiceDraw1",12];
alphatab.tablature.drawing.DrawingLayers.VoiceDraw1.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.VoiceDraw1.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.VoiceDraw2 = ["VoiceDraw2",8];
alphatab.tablature.drawing.DrawingLayers.VoiceDraw2.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.VoiceDraw2.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.VoiceEffects1 = ["VoiceEffects1",10];
alphatab.tablature.drawing.DrawingLayers.VoiceEffects1.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.VoiceEffects1.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.VoiceEffects2 = ["VoiceEffects2",6];
alphatab.tablature.drawing.DrawingLayers.VoiceEffects2.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.VoiceEffects2.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw1 = ["VoiceEffectsDraw1",11];
alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw1.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw1.__enum__ = alphatab.tablature.drawing.DrawingLayers;
alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw2 = ["VoiceEffectsDraw2",7];
alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw2.toString = $estr;
alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw2.__enum__ = alphatab.tablature.drawing.DrawingLayers;
Reflect = function() { }
...
alphatab.file.gpx.score.Score = function(p) { if( p === $_ ) return; {
	null;
}}
alphatab.file.gpx.score.Score.__name__ = ["alphatab","file","gpx","score","Score"];
alphatab.file.gpx.score.Score.prototype.album = null;
alphatab.file.gpx.score.Score.prototype.artist = null;
alphatab.file.gpx.score.Score.prototype.copyright = null;
alphatab.file.gpx.score.Score.prototype.instructions = null;
alphatab.file.gpx.score.Score.prototype.music = null;
alphatab.file.gpx.score.Score.prototype.notices = null;
alphatab.file.gpx.score.Score.prototype.subTitle = null;
alphatab.file.gpx.score.Score.prototype.tabber = null;
alphatab.file.gpx.score.Score.prototype.title = null;
alphatab.file.gpx.score.Score.prototype.words = null;
alphatab.file.gpx.score.Score.prototype.wordsAndMusic = null;
alphatab.file.gpx.score.Score.prototype.__class__ = alphatab.file.gpx.score.Score;
alphatab.file.gpx.score.Voice = function(p) { if( p === $_ ) return; {
	null;
}}
alphatab.file.gpx.score.Voice.__name__ = ["alphatab","file","gpx","score","Voice"];
alphatab.file.gpx.score.Voice.prototype.beatIds = null;
alphatab.file.gpx.score.Voice.prototype.id = null;
alphatab.file.gpx.score.Voice.prototype.__class__ = alphatab.file.gpx.score.Voice;
...
alphatab.tablature.model.TripletGroup.prototype.paint = function(layout,context,x,y) {
	var scale = layout.scale;
	var offset = alphatab.tablature.drawing.DrawingResources.getScoreNoteSize(layout,false).width / 2;
	...
	var clef = alphatab.model.MeasureClefConverter.toInt(this._voices[0].beat.measure.clef);
	var realY = y;
	var draw = (this._voiceIndex == 0?context.get(alphatab.tablature.drawing.DrawingLayers.VoiceDraw1):context.get(alphatab.tablature.drawing.DrawingLayers.VoiceDraw2));
	var fill = (this._voiceIndex == 0?context.get(alphatab.tablature.drawing.DrawingLayers.Voice1):context.get(alphatab.tablature.drawing.DrawingLayers.Voice2));
...
alphatab.tablature.model.ChordImpl.prototype.getPaintPosition = function(iIndex) {
...
alphatab.tablature.model.ChordImpl.prototype.paint = function(layout,context,x,y) {
	if(this.name != null && this.name != "") {
		...
		var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.Chord);
		context.get(alphatab.tablature.drawing.DrawingLayers.MainComponents).addString(this.name,alphatab.tablature.drawing.DrawingResources.chordFont,realX,realY);
	}
}
alphatab.tablature.model.ChordImpl.prototype.__class__ = alphatab.tablature.model.ChordImpl;
alphatab.file.gpx.score.Automation = function(p) { if( p === $_ ) return; {
	null;
}}
alphatab.file.gpx.score.Automation.__name__ = ["alphatab","file","gpx","score","Automation"];
alphatab.file.gpx.score.Automation.prototype.barId = null;
alphatab.file.gpx.score.Automation.prototype.linear = null;
alphatab.file.gpx.score.Automation.prototype.position = null;
alphatab.file.gpx.score.Automation.prototype.type = null;
alphatab.file.gpx.score.Automation.prototype.value = null;
alphatab.file.gpx.score.Automation.prototype.visible = null;
alphatab.file.gpx.score.Automation.prototype.__class__ = alphatab.file.gpx.score.Automation;
...
alphatab.tablature.drawing.DrawingResources.getScoreNoteSize = function(layout,full) {
	...
	return new alphatab.model.Size(Math.round(scale * 1.3),Math.round(scale));
}
...
alphatab.model.Size = function(width,height) { if( width === $_ ) return; {
	this.width = width;
	this.height = height;
}}
alphatab.model.Size.__name__ = ["alphatab","model","Size"];
alphatab.model.Size.prototype.height = null;
alphatab.model.Size.prototype.width = null;
alphatab.model.Size.prototype.__class__ = alphatab.model.Size;
alphatab.model.MeasureHeader = function(factory) { if( factory === $_ ) return; {
	...
	this.marker = null;
	this.tripletFeel = alphatab.model.TripletFeel.None;
...
alphatab.tablature.model.MeasureHeaderImpl.prototype.calculateMeasureChanges = function(layout) {
	...
	if(previous == null) {
		...
		this.shouldPaintTripletFeel = this.tripletFeel != alphatab.model.TripletFeel.None;
...
alphatab.midi.MidiMessageUtils.noteOn = function(channel,note,velocity) {
	return (("0" + alphatab.midi.MidiMessageUtils.channelToString(alphatab.midi.MidiMessageUtils.fixChannel(channel))) + alphatab.midi.MidiMessageUtils.valueToString(alphatab.midi.MidiMessageUtils.fixValue(note))) + alphatab.midi.MidiMessageUtils.valueToString(alphatab.midi.MidiMessageUtils.fixValue(velocity));
}
alphatab.midi.MidiMessageUtils.noteOff = function(channel,note,velocity) {
	return (("1" + alphatab.midi.MidiMessageUtils.channelToString(alphatab.midi.MidiMessageUtils.fixChannel(channel))) + alphatab.midi.MidiMessageUtils.valueToString(alphatab.midi.MidiMessageUtils.fixValue(note))) + alphatab.midi.MidiMessageUtils.valueToString(alphatab.midi.MidiMessageUtils.fixValue(velocity));
}
alphatab.midi.MidiMessageUtils.controlChange = function(channel,controller,value) {
	return (("2" + alphatab.midi.MidiMessageUtils.channelToString(alphatab.midi.MidiMessageUtils.fixChannel(channel))) + alphatab.midi.MidiMessageUtils.valueToString(alphatab.midi.MidiMessageUtils.fixValue(controller))) + alphatab.midi.MidiMessageUtils.valueToString(alphatab.midi.MidiMessageUtils.fixValue(value));
}
alphatab.midi.MidiMessageUtils.programChange = function(channel,instrument) {
	return ("3" + alphatab.midi.MidiMessageUtils.channelToString(alphatab.midi.MidiMessageUtils.fixChannel(channel))) + alphatab.midi.MidiMessageUtils.valueToString(alphatab.midi.MidiMessageUtils.fixValue(instrument));
}
alphatab.midi.MidiMessageUtils.pitchBend = function(channel,value) {
	return ("4" + alphatab.midi.MidiMessageUtils.channelToString(alphatab.midi.MidiMessageUtils.fixChannel(channel))) + alphatab.midi.MidiMessageUtils.valueToString(alphatab.midi.MidiMessageUtils.fixValue(value));
}
alphatab.midi.MidiMessageUtils.systemReset = function() {
	return "5";
}
alphatab.midi.MidiMessageUtils.tempoInUSQ = function(usq) {
	return "6" + alphatab.midi.MidiMessageUtils.intToString(usq);
}
alphatab.midi.MidiMessageUtils.timeSignature = function(ts) {
	return (((("7" + alphatab.midi.MidiMessageUtils.intToString(ts.numerator)) + ",") + alphatab.midi.MidiMessageUtils.intToString(ts.denominator.index())) + ",") + alphatab.midi.MidiMessageUtils.intToString(ts.denominator.value);
}
			...
			while(_g1 < _g) {
				...
				if(index < beats.length) {
					...
					if(str.length > 0) {
						...
						context.get(alphatab.tablature.drawing.DrawingLayers.MainComponents).addString(str,alphatab.tablature.drawing.DrawingResources.defaultFont,realX + 13,y + currentMeasure.ts.get(alphatab.tablature.TrackSpacingPositions.Lyric));
					}
				}
				beatIndex++;
			}
...
alphatab.tablature.model.NoteImpl.prototype.paint = function(layout,context,x,y) {
	...
	this.paintScoreNote(layout,context,x,y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines),spacing);
	this.paintOfflineEffects(layout,context,x,y,spacing);
	this.paintTablatureNote(layout,context,x,y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.Tablature),spacing);
}
alphatab.tablature.model.NoteImpl.prototype.paintAccentuated = function(layout,context,x,y) {
	var layer = (this.voice.index == 0?context.get(alphatab.tablature.drawing.DrawingLayers.Voice1):context.get(alphatab.tablature.drawing.DrawingLayers.Voice2));
...
alphatab.tablature.model.NoteImpl.prototype.paintBend = function(layout,context,nextBeat,fromX,fromY) {
	...
	var fill = (this.voice.index == 0?context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffects1):context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffects2));
	var draw = (this.voice.index == 0?context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw1):context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw2));
...
alphatab.tablature.model.NoteImpl.prototype.paintGrace = function(layout,context,x,y) {
	...
	if(this.effect.grace.transition == alphatab.model.effects.GraceEffectTransition.Hammer || this.effect.grace.transition == alphatab.model.effects.GraceEffectTransition.Slide) {
...
alphatab.tablature.model.NoteImpl.prototype.paintOfflineEffects = function(layout,context,x,y,spacing) {
	...
	if(effect.accentuatedNote) {
		var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.AccentuatedEffect);
	...
	if(effect.isHarmonic()) {
		var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.HarmonicEffect);
		var key = "";
	...
	if(effect.letRing) {
		...
		var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.LetRingEffect);
	...
	if(effect.palmMute) {
		...
		var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.PalmMuteEffect);
		var height = alphatab.tablature.drawing.DrawingResources.defaultFontHeight;
		var startX = realX;
		if(!nextPalm) {
			endX -= 6 * layout.scale;
	...
	if(effect.vibrato) {
		var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.VibratoEffect);
...
alphatab.tablature.model.NoteImpl.prototype.paintScoreNote = function(layout,context,x,y,spacing) {
	...
	var clef = alphatab.model.MeasureClefConverter.toInt(this.measureImpl().clef);
	var realX = x + 4 * layout.scale;
	var realY1 = y + this.scorePosY;
	var fill = (this.voice.index == 0?context.get(alphatab.tablature.drawing.DrawingLayers.Voice1):context.get(alphatab.tablature.drawing.DrawingLayers.Voice2));
	var effectLayer = (this.voice.index == 0?context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffects1):context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffects2));
	if(this.isTiedNote) {
	...
	var xMove = (direction == alphatab.model.VoiceDirection.Up?alphatab.tablature.drawing.DrawingResources.getScoreNoteSize(layout,false).width:0);
	var realY2 = y + this.voice.beatGroup.getY2(layout,this.posX() + spacing,key,clef);
	if(this.effect.staccato) {
		var Size = 3;
		var stringX = realX + xMove;
		var stringY = (realY2 + (4 * (((direction == alphatab.model.VoiceDirection.Up)?-1:1))));
		fill.addCircle(stringX - (Size / 2),stringY - (Size / 2),Size);
	}
	if(this.effect.isTremoloPicking()) {
		var trillY = (direction != alphatab.model.VoiceDirection.Up?realY1 + Math.floor(8 * layout.scale):realY1 - Math.floor(16 * layout.scale));
		var trillX = (direction != alphatab.model.VoiceDirection.Up?realX - Math.floor(5 * layout.scale):realX + Math.floor(3 * layout.scale));
		var s = "";
		switch(this.effect.tremoloPicking.duration.value) {
		case 8:{
			s = alphatab.tablature.drawing.MusicFont.TrillUpEigth;
			if(direction == alphatab.model.VoiceDirection.Down) trillY += Math.floor(8 * layout.scale);
		}break;
		case 16:{
			s = alphatab.tablature.drawing.MusicFont.TrillUpSixteenth;
			if(direction == alphatab.model.VoiceDirection.Down) trillY += Math.floor(4 * layout.scale);
		}break;
		case 32:{
...
alphatab.tablature.model.NoteImpl.prototype.paintSlide = function(layout,context,nextNote,x,y,nextX) {
	...
	var draw = (this.voice.index == 0?context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw1):context.get(alphatab.tablature.drawing.DrawingLayers.VoiceEffectsDraw2));
	draw.startFigure();
	if(this.effect.slideType == alphatab.model.SlideType.IntoFromBelow) {
		realY += yMove;
		rextY -= yMove;
		draw.addLine(this._noteOrientation.x - xMove,realY,this._noteOrientation.x,rextY);
	}
	else if(this.effect.slideType == alphatab.model.SlideType.IntoFromAbove) {
		realY -= yMove;
		rextY += yMove;
		draw.addLine(this._noteOrientation.x - xMove,realY,this._noteOrientation.x,rextY);
	}
	else if(this.effect.slideType == alphatab.model.SlideType.OutDownWards) {
		realY -= yMove;
		rextY += yMove;
	...
	else if(this.effect.slideType == alphatab.model.SlideType.OutUpWards) {
		realY += yMove;
		rextY -= yMove;
		draw.addLine(this._noteOrientation.x + this._noteOrientation.width,realY,(this._noteOrientation.x + this._noteOrientation.width) + xMove,rextY);
	}
		...
		if(this.effect.slideType == alphatab.model.SlideType.SlowSlideTo) {
...
alphatab.tablature.model.NoteImpl.prototype.update = function(layout) {
	...
	this.scorePosY = this.voice.beatGroup.getY1(layout,this,this.measureImpl().keySignature(),alphatab.model.MeasureClefConverter.toInt(this.measureImpl().clef)) + Math.floor(layout.scale);
}
...
alphatab.model.BeatStroke = function(p) { if( p === $_ ) return; {
	this.direction = alphatab.model.BeatStrokeDirection.None;
}}
...
alphatab.model.TripletFeel = { __ename__ : ["alphatab","model","TripletFeel"], __constructs__ : ["None","Eighth","Sixteenth"] }
alphatab.model.TripletFeel.Eighth = ["Eighth",1];
alphatab.model.TripletFeel.Eighth.toString = $estr;
alphatab.model.TripletFeel.Eighth.__enum__ = alphatab.model.TripletFeel;
alphatab.model.TripletFeel.None = ["None",0];
alphatab.model.TripletFeel.None.toString = $estr;
alphatab.model.TripletFeel.None.__enum__ = alphatab.model.TripletFeel;
alphatab.model.TripletFeel.Sixteenth = ["Sixteenth",2];
alphatab.model.TripletFeel.Sixteenth.toString = $estr;
alphatab.model.TripletFeel.Sixteenth.__enum__ = alphatab.model.TripletFeel;
...
alphatab.model.PointF = function(x,y) { if( x === $_ ) return; {
	this.x = x;
	this.y = y;
}}
alphatab.model.PointF.__name__ = ["alphatab","model","PointF"];
alphatab.model.PointF.prototype.x = null;
alphatab.model.PointF.prototype.y = null;
alphatab.model.PointF.prototype.__class__ = alphatab.model.PointF;
...
alphatab.tablature.drawing.KeySignaturePainter.paintFlat = function(context,x,y,layout) {
	...
	var layer = context.get(alphatab.tablature.drawing.DrawingLayers.MainComponents);
...
alphatab.model.effects.GraceEffect = function(p) { if( p === $_ ) return; {
	...
	this.duration = 1;
	this.velocity = 95;
	this.transition = alphatab.model.effects.GraceEffectTransition.None;
	this.isOnBeat = false;
	this.isDead = false;
}}
...
alphatab.tablature.model.VoiceImpl.prototype.getPaintPosition = function(iIndex) {
...
alphatab.tablature.model.VoiceImpl.prototype.paintBeat = function(layout,context,x,y) {
	if(!this.isRestVoice()) {
		...
		this.paintScoreBeat(layout,context,x,y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines),spacing);
	}
}
...
alphatab.tablature.model.VoiceImpl.prototype.paintScoreBeat = function(layout,context,x,y,spacing) {
	...
	var fill = (this.index == 0?context.get(alphatab.tablature.drawing.DrawingLayers.Voice1):context.get(alphatab.tablature.drawing.DrawingLayers.Voice2));
	var draw = (this.index == 0?context.get(alphatab.tablature.drawing.DrawingLayers.VoiceDraw1):context.get(alphatab.tablature.drawing.DrawingLayers.VoiceDraw2));
	this.paintTriplet(layout,context,x,(y - this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines)));
	...
	if(this.duration.value >= 2) {
		...
		var clef = alphatab.model.MeasureClefConverter.toInt(this.beat.measure.clef);
		var xMove = (direction == alphatab.model.VoiceDirection.Up?alphatab.tablature.drawing.DrawingResources.getScoreNoteSize(layout,false).width:0);
		var yMove = (direction == alphatab.model.VoiceDirection.Up?Math.round(layout.scoreLineSpacing / 3) + 1:Math.round(layout.scoreLineSpacing / 3) * 2);
		var vY1 = y + (((direction == alphatab.model.VoiceDirection.Down)?this.maxNote.scorePosY:this.minNote.scorePosY));
		...
		if(this.duration.value >= 8) {
			...
			if(index >= 0) {
				var dir = (direction == alphatab.model.VoiceDirection.Down?1:-1);
...
alphatab.tablature.model.VoiceImpl.prototype.paintSilence = function(layout,context,x,y) {
	var realX = x + 3 * layout.scale;
	var realY = y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines);
	var lineSpacing = layout.scoreLineSpacing;
...
alphatab.tablature.model.VoiceImpl.prototype.paintTriplet = function(layout,context,x,y) {
	...
	if(!this.duration.tuplet.equals(new alphatab.model.Tuplet())) {
		if(this.tripletGroup.isFull() && (this.previousBeat == null || this.previousBeat.tripletGroup == null || this.previousBeat.tripletGroup != this.tripletGroup)) {
			...
			fill.addString(Std.string(this.duration.tuplet.enters),alphatab.tablature.drawing.DrawingResources.defaultFont,Math.round(realX),Math.round(y + this.getPaintPosition(alphatab.tablature.TrackSpacingPositions.Tupleto)));
		}
	}
}
...
alphatab.tablature.model.VoiceImpl.prototype.updateNoteVoice = function(layout) {
	...
	if(this.beatGroup.direction == alphatab.model.VoiceDirection.Down) {
...
alphatab.file.gpx.score.Bar = function(p) { if( p === $_ ) return; {
	null;
}}
alphatab.file.gpx.score.Bar.__name__ = ["alphatab","file","gpx","score","Bar"];
alphatab.file.gpx.score.Bar.prototype.clef = null;
alphatab.file.gpx.score.Bar.prototype.id = null;
alphatab.file.gpx.score.Bar.prototype.simileMark = null;
alphatab.file.gpx.score.Bar.prototype.voiceIds = null;
alphatab.file.gpx.score.Bar.prototype.__class__ = alphatab.file.gpx.score.Bar;
...
alphatab.midi.MidiSequenceParser.getStroke = function(beat,previous,stroke) {
	...
	if(((previous == null) || (direction != alphatab.model.BeatStrokeDirection.None)) || (previous.effect.stroke.direction != alphatab.model.BeatStrokeDirection.None)) {
		if(direction == alphatab.model.BeatStrokeDirection.None) {
			{
			...
			if(stringCount > 0) {
				...
				var strokeIncrement = beat.effect.stroke.getIncrementTime(beat);
				{
					...
					while(_g1 < _g) {
						var i = _g1++;
						var iIndex = ((direction != alphatab.model.BeatStrokeDirection.Down)?i:((stroke.length - 1) - i));
...
alphatab.midi.MidiSequenceParser.prototype.checkTripletFeel = function(voice,beatIndex) {
	...
	if(voice.beat.measure.tripletFeel() == alphatab.model.TripletFeel.Eighth) {
	...
	else if(voice.beat.measure.tripletFeel() == alphatab.model.TripletFeel.Sixteenth) {
	...
	graphics.beginPath();
	{
		...
		while(_g < _g1.length) {
			...
			try {
				...
				if( js.Boot.__instanceof($e32,String) ) {
					var err = $e32;
					{
						throw err;
					}
...
alphatab.file.gpx.score.Beat = function(p) { if( p === $_ ) return; {
	null;
}}
alphatab.file.gpx.score.Beat.__name__ = ["alphatab","file","gpx","score","Beat"];
alphatab.file.gpx.score.Beat.prototype.dyn = null;
alphatab.file.gpx.score.Beat.prototype.id = null;
alphatab.file.gpx.score.Beat.prototype.noteIDs = null;
alphatab.file.gpx.score.Beat.prototype.rythmId = null;
alphatab.file.gpx.score.Beat.prototype.__class__ = alphatab.file.gpx.score.Beat;
...
alphatab.tablature.Tablature.prototype.doLayout = function() {
	...
	haxe.Log.trace("Starting layouting",{ fileName : "Tablature.hx", lineNumber : 92, className : "alphatab.tablature.Tablature", methodName : "doLayout"});
	...
	this.viewLayout.prepareLayout(new alphatab.model.Rectangle(0,0,size.width,size.height),0,0);
	if(this.autoSizeWidth) this.canvas.setWidth(this.viewLayout.width);
	this.canvas.setHeight(this.viewLayout.height);
	haxe.Log.trace("Layouting finished",{ fileName : "Tablature.hx", lineNumber : 105, className : "alphatab.tablature.Tablature", methodName : "doLayout"});
}
...
alphatab.tablature.Tablature.prototype.onPaint = function() {
	...
	haxe.Log.trace("Drawing Finished",{ fileName : "Tablature.hx", lineNumber : 133, className : "alphatab.tablature.Tablature", methodName : "onPaint"});
}
...
alphatab.tablature.Tablature.prototype.setTrack = function(track) {
	haxe.Log.trace("Updating Track",{ fileName : "Tablature.hx", lineNumber : 70, className : "alphatab.tablature.Tablature", methodName : "setTrack"});
	this.track = track;
...
alphatab.model.effects.BendTypes = { __ename__ : ["alphatab","model","effects","BendTypes"], __constructs__ : ["None","Bend","BendRelease","BendReleaseBend","Prebend","PrebendRelease","Dip","Dive","ReleaseUp","InvertedDip","Return","ReleaseDown"] }
alphatab.model.effects.BendTypes.Bend = ["Bend",1];
alphatab.model.effects.BendTypes.Bend.toString = $estr;
alphatab.model.effects.BendTypes.Bend.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.BendRelease = ["BendRelease",2];
alphatab.model.effects.BendTypes.BendRelease.toString = $estr;
alphatab.model.effects.BendTypes.BendRelease.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.BendReleaseBend = ["BendReleaseBend",3];
alphatab.model.effects.BendTypes.BendReleaseBend.toString = $estr;
alphatab.model.effects.BendTypes.BendReleaseBend.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.Dip = ["Dip",6];
alphatab.model.effects.BendTypes.Dip.toString = $estr;
alphatab.model.effects.BendTypes.Dip.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.Dive = ["Dive",7];
alphatab.model.effects.BendTypes.Dive.toString = $estr;
alphatab.model.effects.BendTypes.Dive.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.InvertedDip = ["InvertedDip",9];
alphatab.model.effects.BendTypes.InvertedDip.toString = $estr;
alphatab.model.effects.BendTypes.InvertedDip.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.None = ["None",0];
alphatab.model.effects.BendTypes.None.toString = $estr;
alphatab.model.effects.BendTypes.None.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.Prebend = ["Prebend",4];
alphatab.model.effects.BendTypes.Prebend.toString = $estr;
alphatab.model.effects.BendTypes.Prebend.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.PrebendRelease = ["PrebendRelease",5];
alphatab.model.effects.BendTypes.PrebendRelease.toString = $estr;
alphatab.model.effects.BendTypes.PrebendRelease.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.ReleaseDown = ["ReleaseDown",11];
alphatab.model.effects.BendTypes.ReleaseDown.toString = $estr;
alphatab.model.effects.BendTypes.ReleaseDown.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.ReleaseUp = ["ReleaseUp",8];
alphatab.model.effects.BendTypes.ReleaseUp.toString = $estr;
alphatab.model.effects.BendTypes.ReleaseUp.__enum__ = alphatab.model.effects.BendTypes;
alphatab.model.effects.BendTypes.Return = ["Return",10];
alphatab.model.effects.BendTypes.Return.toString = $estr;
alphatab.model.effects.BendTypes.Return.__enum__ = alphatab.model.effects.BendTypes;
...
alphatab.tablature.drawing.TempoPainter.paintTempo = function(context,x,y,scale) {
	...
	var layer = context.get(alphatab.tablature.drawing.DrawingLayers.MainComponents);
	var draw = context.get(alphatab.tablature.drawing.DrawingLayers.MainComponentsDraw);
...
alphatab.model.effects.BendTypesConverter = function() { }
alphatab.model.effects.BendTypesConverter.__name__ = ["alphatab","model","effects","BendTypesConverter"];
alphatab.model.effects.BendTypesConverter.fromInt = function(i) {
	switch(i) {
	case 0:{
		return alphatab.model.effects.BendTypes.None;
	}break;
	case 1:{
		return alphatab.model.effects.BendTypes.Bend;
	}break;
	case 2:{
		return alphatab.model.effects.BendTypes.BendRelease;
	}break;
	case 3:{
		return alphatab.model.effects.BendTypes.BendReleaseBend;
	}break;
	case 4:{
		return alphatab.model.effects.BendTypes.Prebend;
	}break;
	case 5:{
		return alphatab.model.effects.BendTypes.PrebendRelease;
	}break;
	case 6:{
		return alphatab.model.effects.BendTypes.Dip;
	}break;
	case 7:{
		return alphatab.model.effects.BendTypes.Dive;
	}break;
	case 8:{
		return alphatab.model.effects.BendTypes.ReleaseUp;
	}break;
	case 9:{
		return alphatab.model.effects.BendTypes.InvertedDip;
	}break;
	case 10:{
		return alphatab.model.effects.BendTypes.Return;
	}break;
	case 11:{
		return alphatab.model.effects.BendTypes.ReleaseDown;
	}break;
	default:{
		return alphatab.model.effects.BendTypes.None;
	}break;
...
alphatab.model.effects.BendTypesConverter.prototype.__class__ = alphatab.model.effects.BendTypesConverter;
...
alphatab.tablature.TrackSpacing.prototype.get = function(index) {
	var size = 0;
	var realIndex = alphatab.tablature.TrackSpacingPositionConverter.toInt(index);
	{
		var _g = 0;
		while(_g < realIndex) {
			var i = _g++;
...
alphatab.tablature.TrackSpacing.prototype.getSize = function() {
	return this.get(alphatab.tablature.TrackSpacingPositions.Bottom);
}
...
alphatab.tablature.model.BeatGroup.prototype.checkVoice = function(voice) {
	...
	this._voices.push(voice);
	if(voice.direction != alphatab.model.VoiceDirection.None) {
...
alphatab.tablature.model.BeatGroup.prototype.finish = function(layout,measure) {
	if(this.direction == alphatab.model.VoiceDirection.None) {
		if(measure.notEmptyVoices > 1) {
			this.direction = (this._voice == 0?alphatab.model.VoiceDirection.Up:alphatab.model.VoiceDirection.Down);
		}
		else {
			var max = Math.abs(this.minNote.realValue() - (alphatab.tablature.model.BeatGroup.SCORE_MIDDLE_KEYS[alphatab.model.MeasureClefConverter.toInt(measure.clef) - 1] + 100));
			var min = Math.abs(this.maxNote.realValue() - (alphatab.tablature.model.BeatGroup.SCORE_MIDDLE_KEYS[alphatab.model.MeasureClefConverter.toInt(measure.clef) - 1] - 100));
			this.direction = (max > min?alphatab.model.VoiceDirection.Up:alphatab.model.VoiceDirection.Down);
		}
	}
}
alphatab.tablature.model.BeatGroup.prototype.getY1 = function(layout,note,key,clef) {
	...
	scoreLineY += Math.floor(alphatab.tablature.model.MeasureImpl.SCORE_KEY_OFFSETS[clef - 1] * scale);
	return scoreLineY;
}
alphatab.tablature.model.BeatGroup.prototype.getY2 = function(layout,x,key,clef) {
	...
	var y1;
	var y2;
	if(this.direction == alphatab.model.VoiceDirection.Down) {
...
alphatab.tablature.model.MeasureImpl.prototype.checkValue = function(layout,note,direction) {
	...
	var upOffset = alphatab.tablature.model.BeatGroup.getUpOffset(layout);
	var downOffset = alphatab.tablature.model.BeatGroup.getDownOffset(layout);
	if(direction == alphatab.model.VoiceDirection.Up && y > this.maxY) {
		this.maxY = y;
	}
	else if(direction == alphatab.model.VoiceDirection.Down && (y + downOffset) > this.maxY) {
		this.maxY = Math.floor((y + downOffset) + 2);
	}
	if(direction == alphatab.model.VoiceDirection.Up && (y - upOffset) < this.minY) {
		this.minY = Math.floor((y - upOffset) - 2);
	}
	else if(direction == alphatab.model.VoiceDirection.Down && y < this.minY) {
		this.minY = y;
	}
}
...
alphatab.tablature.model.MeasureImpl.prototype.paintClef = function(layout,context,fromX,fromY) {
	if(this.isPaintClef) {
		...
		var y = fromY + this.ts.get(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines);
		if(this.clef == alphatab.model.MeasureClef.Treble) {
			alphatab.tablature.drawing.ClefPainter.paintTreble(context,x,y,layout);
		}
		else if(this.clef == alphatab.model.MeasureClef.Bass) {
			alphatab.tablature.drawing.ClefPainter.paintBass(context,x,y,layout);
		}
		else if(this.clef == alphatab.model.MeasureClef.Tenor) {
			alphatab.tablature.drawing.ClefPainter.paintTenor(context,x,y,layout);
		}
		else if(this.clef == alphatab.model.MeasureClef.Alto) {
...
alphatab.tablature.model.MeasureImpl.prototype.paintDivisions = function(layout,context) {
	...
	var offsetY = 0;
	var y1 = this.posY + this.ts.get(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines);
	var y2 = Math.floor(y1 + (layout.scoreLineSpacing * 4));
	if(layout.isFirstMeasure(this) || this.isFirstOfLine) {
		offsetY = (this.posY + this.ts.get(alphatab.tablature.TrackSpacingPositions.Tablature)) - y2;
	}
	this.paintDivisions2(layout,context,x1,y1,x2,y2,offsetY,true);
	y1 = this.posY + this.ts.get(alphatab.tablature.TrackSpacingPositions.Tablature);
...
alphatab.tablature.model.MeasureImpl.prototype.paintDivisions2 = function(layout,context,x1,y1,x2,y2,offsetY,addInfo) {
	...
	var fill = context.get(alphatab.tablature.drawing.DrawingLayers.MainComponents);
	var draw = context.get(alphatab.tablature.drawing.DrawingLayers.MainComponentsDraw);
	if(addInfo) {
		var number = Std.string(this.number());
		context.get(alphatab.tablature.drawing.DrawingLayers.Red).addString(number,alphatab.tablature.drawing.DrawingResources.defaultFont,(this.posX + Math.round(scale)),((y1 - alphatab.tablature.drawing.DrawingResources.defaultFontHeight) - Math.round(scale)));
	}
...
alphatab.tablature.model.MeasureImpl.prototype.paintMarker = function(context,layout) {
	if(this.hasMarker()) {
		...
		var y = (this.posY + this.ts.get(alphatab.tablature.TrackSpacingPositions.Marker));
		context.get(alphatab.tablature.drawing.DrawingLayers.Voice1).addString(this.marker().title,alphatab.tablature.drawing.DrawingResources.defaultFont,x,y);
	}
}
...
alphatab.tablature.model.MeasureImpl.prototype.paintRepeatEnding = function(layout,context) {
	if(this.header.repeatAlternative > 0) {
		...
		var y1 = (this.posY + this.ts.get(alphatab.tablature.TrackSpacingPositions.RepeatEnding));
		...
		layer.lineTo(x1,y1);
		layer.lineTo(x2,y1);
		context.get(alphatab.tablature.drawing.DrawingLayers.MainComponents).addString(sText,alphatab.tablature.drawing.DrawingResources.defaultFont,Math.round(x1 + (5.0 * scale)),Math.round(y1 + alphatab.tablature.drawing.DrawingResources.defaultFontHeight));
	}
}
alphatab.tablature.model.MeasureImpl.prototype.paintTempo = function(context,layout) {
	if(this.headerImpl().shouldPaintTempo) {
		...
		y += (this.ts.get(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines) - lineSpacing);
		var imgX = x;
		...
		context.get(alphatab.tablature.drawing.DrawingLayers.MainComponents).addString(value,alphatab.tablature.drawing.DrawingResources.defaultFont,fontX,fontY);
	}
}
...
alphatab.tablature.model.MeasureImpl.prototype.paintTimeSignature = function(context,layout,fromX,fromY) {
	if(this.headerImpl().shouldPaintTimeSignature) {
		...
		if(symbol != null) {
			context.get(alphatab.tablature.drawing.DrawingLayers.MainComponents).addMusicSymbol(symbol,fromX + x,y + y1,scale);
		}
		var denominator = this.timeSignature().denominator.value;
		symbol = this.getTimeSignatureSymbol(denominator);
		if(symbol != null) {
			context.get(alphatab.tablature.drawing.DrawingLayers.MainComponents).addMusicSymbol(symbol,fromX + x,y + y2,scale);
		}
	}
}
alphatab.tablature.model.MeasureImpl.prototype.paintTripletFeel = function(context,layout) {
	if(this.headerImpl().shouldPaintTripletFeel) {
		...
		var y = (this.posY + this.ts.get(alphatab.tablature.TrackSpacingPositions.ScoreMiddleLines)) - lineSpacing;
		var y1 = y - (Math.round((3.5 * scale)));
		if(this.tripletFeel() == alphatab.model.TripletFeel.None && this._previousMeasure != null) {
			var previous = this._previousMeasure.tripletFeel();
			if(previous == alphatab.model.TripletFeel.Eighth) {
				alphatab.tablature.drawing.TripletFeelPainter.paintTripletFeelNone8(context,x,y1,layout.scale);
			}
			else if(previous == alphatab.model.TripletFeel.Sixteenth) {
				alphatab.tablature.drawing.TripletFeelPainter.paintTripletFeelNone16(context,x,y1,layout.scale);
			}
		}
		else if(this.tripletFeel() == alphatab.model.TripletFeel.Eighth) {
			alphatab.tablature.drawing.TripletFeelPainter.paintTripletFeel8(context,x,y1,layout.scale);
		}
		else if(this.tripletFeel() == alphatab.model.TripletFeel.Sixteenth) {
...
alphatab.tablature.model.MeasureImpl.prototype.registerSpacing = function(layout,spacing) {
	if(this.hasMarker()) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.Marker,layout.markerSpacing);
	}
	if(this._chord) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.Chord,layout.getDefaultChordSpacing());
	}
	if(this._text) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.Text,layout.textSpacing);
	}
	if(this.header.repeatAlternative > 0) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.RepeatEnding,layout.repeatEndingSpacing);
	}
	if(this._tupleto) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.Tupleto,layout.tupletoSpacing);
	}
	if(this._accentuated) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.AccentuatedEffect,layout.effectSpacing);
	}
	if(this._harmonic) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.HarmonicEffect,layout.effectSpacing);
	}
	if(this._tapping) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.TapingEffect,layout.effectSpacing);
	}
	if(this._palmMute) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.PalmMuteEffect,layout.effectSpacing);
	}
	if(this._fadeIn) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.FadeIn,layout.effectSpacing);
	}
	if(this._vibrato) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.VibratoEffect,layout.effectSpacing);
	}
	if(this._beatVibrato) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.BeatVibratoEffect,layout.effectSpacing);
	}
	if(this._letRing) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.LetRingEffect,layout.effectSpacing);
	}
	if(this._bend) {
		spacing.set(alphatab.tablature.TrackSpacingPositions.Bend,this._bendOverFlow);
	}
	if(this._tremoloBar) {
		if(this._tremoloBarOverFlow < 0) {
			spacing.set(alphatab.tablature.TrackSpacingPositions.TremoloBarDown,Math.round(Math.abs(this._tremoloBarOverFlow)));
		}
	}
}
...
alphatab.model.Measure.DEFAULT_CLEF = alphatab.model.MeasureClef.Treble;
...
alphatab.model.effects.HarmonicEffect.NATURAL_FREQUENCIES = (function($this) {
	var $r;
	var a = new Array();
	a.push([12,12]);
	a.push([9,28]);
